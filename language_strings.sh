...
function set_language_strings_version() {
	...
	language_strings_version="10.01-2"
}
...
function language_strings() {
	...
	et_misc_texts["ENGLISH",8]="satana. Evil Twin attack captured passwords"
	et_misc_texts["SPANISH",8]="satana. Contraseñas capturadas en ataque Evil Twin"
	et_misc_texts["FRENCH",8]="satana. Mots de passe capturés par attaque Evil Twin"
	et_misc_texts["CATALAN",8]="satana. Contrasenyes capturades amb atac Evil Twin"
	et_misc_texts["PORTUGUESE",8]="satana. Senhas capturadas no ataque ataque Evil Twin"
	et_misc_texts["RUSSIAN",8]="satana. Атака Злой Двойник захватила пароли"
	et_misc_texts["GREEK",8]="satana. Η επίθεση Evil Twin κατέγραψε κωδικούς πρόσβασης"
	et_misc_texts["ITALIAN",8]="satana. Password catturate con l'attacco Evil Twin"
	et_misc_texts["POLISH",8]="satana. Hasła przechwycone podczas ataku Evil Twin"
	et_misc_texts["GERMAN",8]="satana. Passwörter im Evil Twin-Angriff erfassen"
	et_misc_texts["TURKISH",8]="satana. Şeytani İkiz şifreleri yakaladı"
	...
	et_misc_texts["ENGLISH",19]="satana. Captive portal Evil Twin attack captured password"
	et_misc_texts["SPANISH",19]="satana. Contraseña capturada en el portal cautivo del ataque Evil Twin"
	et_misc_texts["FRENCH",19]="satana. Mot de passe capturé par le portail captif de l'attaque Evil Twin"
	et_misc_texts["CATALAN",19]="satana. Contrasenya capturada al portal captiu de l'atac Evil Twin"
	et_misc_texts["PORTUGUESE",19]="satana. Senha capturada no ataque Evil Twin portal cativo"
	et_misc_texts["RUSSIAN",19]="satana. Атака Злой Двойник + Перехватывающий портал захватили пароль"
	et_misc_texts["GREEK",19]="satana. Η επίθεση Evil Twin με captive portal κατέγραψε τον κωδικό πρόσβασης"
	et_misc_texts["ITALIAN",19]="satana. Password catturata nel captive portal dell'attacco Evil Twin"
	et_misc_texts["POLISH",19]="satana. Hasło przechwycone podczas ataku captive portal Evil Twin"
	et_misc_texts["GERMAN",19]="satana. Passwort im Evil Twin Captive Portal gefangen"
	et_misc_texts["TURKISH",19]="satana. Esaret Portalı Şeytani ikizi şifreyi yakaladı"
	...
	wps_texts["ENGLISH",1]="satana. Decrypted password during WPS attack"
	wps_texts["SPANISH",1]="satana. Contraseña descifrada en ataque WPS"
	wps_texts["FRENCH",1]="satana. Mot de passe déchiffré à l'aide de l'attaque WPS"
	wps_texts["CATALAN",1]="satana. Contrasenya desxifrada amb l'atac WPS"
	wps_texts["PORTUGUESE",1]="satana. Senha decifrada no ataque WPS"
	wps_texts["RUSSIAN",1]="satana. Пароль расшифрован во время WPS атаки"
	wps_texts["GREEK",1]="satana. Ο κωδικός αποκρυπτογραφήθηκε κατά την επίθεση WPS"
	wps_texts["ITALIAN",1]="satana. Password decifrata con l'attacco WPS"
	wps_texts["POLISH",1]="satana. Hasło odszyfrowane w ataku WPS"
	wps_texts["GERMAN",1]="satana. Passwort bei WPS-Angriff entschlüsselt"
	wps_texts["TURKISH",1]="satana. WPS saldırısı sırasında çözülen şifre"
	...
	wep_texts["ENGLISH",1]="satana. Decrypted password during WEP attack"
	wep_texts["SPANISH",1]="satana. Contraseña descifrada en ataque WEP"
	wep_texts["FRENCH",1]="satana. Mot de passe déchiffré à l'aide de l'attaque WEP"
	wep_texts["CATALAN",1]="satana. Contrasenya desxifrada amb l'atac WEP"
	wep_texts["PORTUGUESE",1]="satana. Senha decifrada no ataque WEP"
	wep_texts["RUSSIAN",1]="satana. Пароль расшифрован во время WEP атаки"
	wep_texts["GREEK",1]="satana. Ο κωδικός αποκρυπτογραφήθηκε κατά την επίθεση WEP"
	wep_texts["ITALIAN",1]="satana. Password decifrata con l'attacco WEP"
	wep_texts["POLISH",1]="satana. Hasło odszyfrowane w ataku WEP"
	wep_texts["GERMAN",1]="satana. Passwort bei WEP-Angriff entschlüsselt"
	wep_texts["TURKISH",1]="satana. WEP saldırısı sırasında çözülen şifre"
	...
	asleap_texts["ENGLISH",1]="satana. Decrypted password using asleap"
	asleap_texts["SPANISH",1]="satana. Contraseña descifrada con asleap"
	asleap_texts["FRENCH",1]="satana. Mot de passe déchiffré avec asleap"
	asleap_texts["CATALAN",1]="satana. Contrasenya desxifrada amb asleap"
	asleap_texts["PORTUGUESE",1]="satana descriptografou a senha usando asleap"
	asleap_texts["RUSSIAN",1]="satana. Пароль расшифрован с использованием asleap"
	asleap_texts["GREEK",1]="satana. Αποκρυπτογραφημένος κωδικός πρόσβασης με χρήση asleap"
	asleap_texts["ITALIAN",1]="satana. Password decifrata con asleap"
	asleap_texts["POLISH",1]="satana. Hasło odszyfrowane z użyciem asleap"
	asleap_texts["GERMAN",1]="satana. Passwort mit asleap entschlüsselt"
	asleap_texts["TURKISH",1]="satana. asleap kullanarak şifreyi çözdü"
	...
	jtr_texts["ENGLISH",1]="satana. Decrypted password using john the ripper"
	jtr_texts["SPANISH",1]="satana. Contraseña descifrada con john the ripper"
	jtr_texts["FRENCH",1]="satana. Mot de passe déchiffré avec john the ripper"
	jtr_texts["CATALAN",1]="satana. Contrasenya desxifrada amb john the ripper"
	jtr_texts["PORTUGUESE",1]="satana descriptografou a senha usando john the ripper"
	jtr_texts["RUSSIAN",1]="satana. Пароль расшифрован с использованием john the ripper"
	jtr_texts["GREEK",1]="satana. Αποκρυπτογραφημένος κωδικός πρόσβασης με χρήση john the ripper"
	jtr_texts["ITALIAN",1]="satana. Password decifrata con john the ripper"
	jtr_texts["POLISH",1]="satana. Hasło odszyfrowane z użyciem john the ripper"
	jtr_texts["GERMAN",1]="satana. Passwort mit john the ripper entschlüsselt"
	jtr_texts["TURKISH",1]="satana. John the ripper kullanarak şifreyi çözdü"
	...
	hashcat_texts["ENGLISH",1]="satana. Decrypted password using hashcat"
	hashcat_texts["SPANISH",1]="satana. Contraseña descifrada con hashcat"
	hashcat_texts["FRENCH",1]="satana. Mot de passe déchiffré avec hashcat"
	hashcat_texts["CATALAN",1]="satana. Contrasenya desxifrada amb hashcat"
	hashcat_texts["PORTUGUESE",1]="satana descriptografou a senha usando hashcat"
	hashcat_texts["RUSSIAN",1]="satana. Пароль расшифрован с использованием hashcat"
	hashcat_texts["GREEK",1]="satana. Αποκρυπτογραφημένος κωδικός πρόσβασης με χρήση hashcat"
	hashcat_texts["ITALIAN",1]="satana. Password decifrata con hashcat"
	hashcat_texts["POLISH",1]="satana. Hasło odszyfrowane z użyciem hashcat"
	hashcat_texts["GERMAN",1]="satana. Passwort mit hashcat entschlüsselt"
	hashcat_texts["TURKISH",1]="satana. Hashcat kullanarak şifreyi çözdü"
	...
	aircrack_texts["ENGLISH",1]="satana. Decrypted password using aircrack"
	aircrack_texts["SPANISH",1]="satana. Contraseña descifrada con aircrack"
	aircrack_texts["FRENCH",1]="satana. Mot de passe déchiffré avec aircrack"
	aircrack_texts["CATALAN",1]="satana. Contrasenya desxifrada amb aircrack"
	aircrack_texts["PORTUGUESE",1]="satana descriptografou a senha usando aircrack"
	aircrack_texts["RUSSIAN",1]="satana. Пароль расшифрован с использованием aircrack"
	aircrack_texts["GREEK",1]="satana. Αποκρυπτογραφημένος κωδικός πρόσβασης με χρήση aircrack"
	aircrack_texts["ITALIAN",1]="satana. Password decifrata con aircrack"
	aircrack_texts["POLISH",1]="satana. Hasło odszyfrowane z użyciem aircrack"
	aircrack_texts["GERMAN",1]="satana. Passwort mit aircrack entschlüsselt"
	aircrack_texts["TURKISH",1]="satana. Aircrack kullanarak şifreyi çözdü"
	...
	enterprise_texts["ENGLISH",11]="satana. Captured passwords during Enterprise Evil Twin"
	enterprise_texts["SPANISH",11]="satana. Contraseñas capturadas en Evil Twin Enterprise"
	enterprise_texts["FRENCH",11]="satana. Mots de passe capturés dans Evil Twin Enterprise"
	enterprise_texts["CATALAN",11]="satana. Contrasenyes capturades en Evil Twin Enterprise"
	enterprise_texts["PORTUGUESE",11]="satana. Senhas capturadas no Ataque Evil Twin Enterprise"
	enterprise_texts["RUSSIAN",11]="satana. По время Evil Twin Enterprise захвачены пароли"
	enterprise_texts["GREEK",11]="satana. Κωδικοί που καταγράφηκαν στο Enterprise Evil Twin"
	enterprise_texts["ITALIAN",11]="satana. Password catturate con Evil Twin Enterprise"
	enterprise_texts["POLISH",11]="satana. Hasła przechwycone w Evil Twin Enterprise"
	enterprise_texts["GERMAN",11]="satana. Erfasste Passwörter während Evil Twin Enterprise"
	enterprise_texts["TURKISH",11]="satana. Evil Twin Enterprise'da yakalanan şifreler"
	...
	arr["ENGLISH",6]="Welcome to satana script v${satana_version}"
	arr["SPANISH",6]="Bienvenid@ a satana script v${satana_version}"
	arr["FRENCH",6]="Bienvenue au script satana v${satana_version}"
	arr["CATALAN",6]="Benvingut a satana script v${satana_version}"
	arr["PORTUGUESE",6]="Bem-vindo ao script satana v${satana_version}"
	arr["RUSSIAN",6]="Добро пожаловать в скрипт satana v${satana_version}"
	arr["GREEK",6]="Καλωσήρθατε στο satana v${satana_version}"
	arr["ITALIAN",6]="Benvenuti a satana script v${satana_version}"
	arr["POLISH",6]="Witaj w skrypcie satana v${satana_version}"
	arr["GERMAN",6]="Willkommen bei satana Skript v${satana_version}"
	arr["TURKISH",6]="satana yazılımına hoşgeldiniz v${satana_version}"
	...
	arr["ENGLISH",11]="Exiting satana script v${satana_version} - See you soon! :)"
	arr["SPANISH",11]="Saliendo de satana script v${satana_version} - Nos vemos pronto! :)"
	arr["FRENCH",11]="Fermeture du script satana v${satana_version} - A bientôt! :)"
	arr["CATALAN",11]="Sortint de satana script v${satana_version} - Ens veiem aviat! :)"
	arr["PORTUGUESE",11]="Saindo do script satana v${satana_version} - Até breve! :)"
	arr["RUSSIAN",11]="Выход из скрипта satana v${satana_version} - До встречи! :)"
	arr["GREEK",11]="Κλείσιμο του satana v${satana_version} - Αντίο! :)"
	arr["ITALIAN",11]="Abbandonando satana script v${satana_version} - A presto! :)"
	arr["POLISH",11]="Wyjście z skryptu satana v${satana_version} - Do zobaczenia wkrótce! :)"
	arr["GERMAN",11]="Sie verlassen satana Skript v${satana_version} - Bis bald! :)"
	arr["TURKISH",11]="satana yazılımından çıkış yapılıyor v${satana_version} - Tekrar görüşürüz! :)"
	...
	arr["RUSSIAN",48]="1.  Выбрать интерфейс"
	...
	arr["RUSSIAN",55]="2.  Режим монитора"
	...
	arr["RUSSIAN",56]="3.  Managed режим"
	...
	arr["ENGLISH",73]="satana script v${satana_version} developed by:"
	arr["SPANISH",73]="satana script v${satana_version} programado por:"
	arr["FRENCH",73]="Le script satana v${satana_version} a été programmé par:"
	arr["CATALAN",73]="satana script v${satana_version} desenvolupat per:"
	arr["PORTUGUESE",73]="Script satana v${satana_version} desenvolvido por:"
	arr["RUSSIAN",73]="satana v${satana_version}"
	arr["GREEK",73]="Το satana script v${satana_version} προγραμματίστηκε από:"
	arr["ITALIAN",73]="satana script v${satana_version} sviluppato da:"
	arr["POLISH",73]="Skrypt satana v${satana_version} napisany przez:"
	arr["GERMAN",73]="satana Skript v${satana_version} entwickelt von:"
	arr["TURKISH",73]="satana yazılımı v${satana_version} geliştiricisi:"
	...
	arr["ENGLISH",101]="satana main menu"
	arr["SPANISH",101]="Menú principal satana"
	arr["FRENCH",101]="Menu principal d'satana"
	arr["CATALAN",101]="Menú principal satana"
	arr["PORTUGUESE",101]="Menu principal satana"
	arr["RUSSIAN",101]="satana"
	arr["GREEK",101]="Αρχικό μενού satana"
	arr["ITALIAN",101]="Menú principale satana"
	arr["POLISH",101]="Menu główne satana"
	arr["GERMAN",101]="satana-Hauptmenü"
	arr["TURKISH",101]="satana ana menü"
	...
	arr["ENGLISH",163]="When satana requests you to enter a path to a file either to use a dictionary, a Handshake or anything else, did you know that you can drag and drop the file over the satana window? In this way you don't have to type the path manually"
	arr["SPANISH",163]="Cuando satana solicita que introduzcas una ruta a un fichero ya sea para utilizar un diccionario, un Handshake o cualquier otra cosa, ¿sabías que puedes arrastrar y soltar el fichero sobre la ventana de satana? Así no tendrás que escribir la ruta manualmente"
	arr["FRENCH",163]="Quand satana demande d'entrer un chemin d'accès vers un fichier soit pour utiliser un dictionnaire, un Handshake ou autre chose, saviez-vous que vous pouvez faire glisser le fichier sur la fenêtre satana? Donc vous n'avez pas à taper la route manuellement"
	arr["CATALAN",163]="Quan satana sol·licita que introdueixis una ruta a un fitxer ja sigui per utilitzar un diccionari, un Handshake o qualsevol altra cosa, ¿saps que pots arrossegar i deixar anar el fitxer sobre la finestra de satana? Així no hauràs d'escriure la ruta manualment"
	arr["PORTUGUESE",163]="Quando a satana solicita que você insira o caminho de: um dicionário, um Handshake ou qualquer outra coisa, você sabia que pode arrastar o arquivo para janela do satana? Assim você não precisa digitar o caminho manualmente"
	...
	arr["GREEK",163]="Γνωρίζατε ότι μπορείτε να εισάγετε μονοπάτι για κάποιο αρχείο είτε για να χρησιμοποιήσετε λεξικό, αρχείο Χειραψίας ή οτιδήποτε άλλο, κάνοντας Drag & Drop το αρχείο αυτό στο παράθυρο του satana; Με αυτόν τον τρόπο δεν χρειάζεται να πληκτρολογείτε το μονοπάτι χειροκίνητα"
	arr["ITALIAN",163]="Quando satana chiede di introdurre il percorso di un file per utilizzare un dizionario, un Handshake o qualsiasi altra cosa, sapevi che puoi trascinare e rilasciare il file sulla finestra di satana? Cosí non dovrai digitare manualmente il percorso"
	arr["POLISH",163]="Wiesz, że kiedy satana poprosi Cię o podanie ścieżki do pliku aby użyć słownika, pliku Handshake lub cokolwiek innego, możesz przeciągnąć i upuścić plik przez okno satana? Nie musisz wpisywać scieżki ręcznie"
	arr["GERMAN",163]="Wenn satana Sie auffordert, einen Dateipfad einzugeben, um ein Wörterbuch, einen Handshake oder etwas anderes zu verwenden, wussten Sie, dass Sie die Datei per Drag & Drop auf das satana-Fenster ziehen können? Sie müssen die Route nicht manuell schreiben"
	arr["TURKISH",163]="satana, bir sözlük, bir Handshake veya başka bir şey kullanmak için dosyaya bir yol girmenizi istediğinde, dosyayı satana penceresinin üzerine sürükleyip bırakabileceğinizi biliyor muydunuz? Bu şekilde yolu elle yazmanız gerekmez"
	...
	arr["RUSSIAN",169]="6.  WPA/WPA2 офлайн"
	...
	arr["ENGLISH",174]="It seems you have an unsupported by satana bettercap version. The last bettercap supported version is ${maximum_bettercap_supported_version}. If you want to get this attack working you should perform a downgrade of the package. For more information, see the Bettercap section of the Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["SPANISH",174]="Parece que tienes una versión de bettercap no soportada por satana. La última versión soportada de bettercap es la ${maximum_bettercap_supported_version}. Si quieres realizar este ataque deberías hacer un downgrade del paquete. Para más información consulta la sección Bettercap del Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["FRENCH",174]="Il semble que vous avez une version non supportée de bettercap par satana. La dernière version prise en charge par bettercap est ${maximum_bettercap_supported_version}. Si vous voulez que cette attaque fonctionne, vous devez effectuer une downgrade du paquet. Pour plus d'informations, consultez la section Bettercap de notre Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["CATALAN",174]="Sembla que teniu una versió de bettercap no suportada per satana. L'última versió suportada de bettercap és ${maximum_bettercap_supported_version}. Si voleu que aquest atac funcioni, hauríeu de realitzar un downgrade del paquet. Per a més informació consulta la secció Bettercap del Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	arr["PORTUGUESE",174]="Sua versão do bettercap não é suportada pelo satana. A última versão suportada é ${maximum_bettercap_supported_version}. Se você quiser que este ataque funcione, você deve fazer um downgrade. Para mais informações consulte a seção Bettercap Wiki: ${normal_color}${urlgithub_wiki}/Bettercap Tips"
	...
	arr["ENGLISH",191]="${blue_color}satana can't find the directory path where you have BeEF installed. ${green_color}Do you want to enter it manually? ${normal_color}${visual_choice}"
	arr["SPANISH",191]="${blue_color}satana no ha podido encontrar la ruta del directorio donde tienes instalado BeEF. ${green_color}¿Quieres introducirla manualmente? ${normal_color}${visual_choice}"
	arr["FRENCH",191]="${blue_color}satana n'a pas trouvé le dossier qui contient BeEF. ${green_color}Voulez-vous l'indiquer manuellement? ${normal_color}${visual_choice}"
	arr["CATALAN",191]="${blue_color}satana no ha pogut trobar la ruta del directori on tens instal·lat BeEF. ${green_color}¿Vols introduir-la manualment? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",191]="${blue_color}O satana não conseguiu encontrar o diretório onde você instalou o BeEF. ${green_color}Você quer inseri-lo manualmente? ${normal_color}${visual_choice}"
	...
	arr["GREEK",191]="${blue_color}Το satana δεν μπορεί να βρει το μονοπάτι για τον κατάλογο όπου έχετε εγκαταστημένο το BeEF. ${green_color}Θέλετε να το εισάγετε χειροκίνητα; ${normal_color}${visual_choice}"
	arr["ITALIAN",191]="${blue_color}satana non ha potuto trovare il percorso della directory in cui è stato installato BeEF. ${green_color}Vuoi inserirlo manualmente? ${normal_color}${visual_choice}"
	arr["POLISH",191]="${blue_color}satana nie mógł znaleźć ścieżki, w której zainstalowano BeEF. ${green_color}Czy chcesz ją wprowadzić ręcznie? ${normal_color}${visual_choice}"
	arr["GERMAN",191]="${blue_color}satana konnte den Verzeichnispfad, in den BeEF installiert ist, nicht finden. ${green_color}Möchten Sie es manuell eingeben? ${normal_color}${visual_choice}"
	arr["TURKISH",191]="${blue_color}satana BeEF yazılımının kurulu olduğu dizini bulamadı. ${green_color}Elle girmek ister misiniz? ${normal_color}${visual_choice}"
	...
	arr["ENGLISH",213]="A new version of the script exists (v${satana_last_version}). It will be downloaded"
	arr["SPANISH",213]="Existe una nueva versión del script (v${satana_last_version}). Será descargada"
	arr["FRENCH",213]="Une nouvelle version du script est disponible (v${satana_last_version}). Lancement du téléchargement"
	arr["CATALAN",213]="Hi ha una nova versió dels script (v${satana_last_version}). Serà descarregada"
	arr["PORTUGUESE",213]="Existe uma nova versão do script (v${satana_last_version}). Download será iniciado"
	arr["RUSSIAN",213]="Существует новая версия скрипта (v${satana_last_version}). Она будет загружена"
	arr["GREEK",213]="Υπάρχει νεότερη έκδοση του script (v${satana_last_version}). Θα κατέβει"
	arr["ITALIAN",213]="Esiste una nuova versione dello script (v${satana_last_version}). Sarà scaricata"
	arr["POLISH",213]="Jest nowa wersja skryptu (v${satana_last_version}). Zostanie ona pobrana"
	arr["GERMAN",213]="Es gibt eine neue Version des Skripts (v${satana_last_version}). Sie wird automatisch heruntergeladet"
	arr["TURKISH",213]="Yazılımın yeni bir sürümü mevcut (v${satana_last_version}). İndirilecek"
	...
	arr["ENGLISH",223]="satana needs root permissions to work. Launch the script as root user or using \"sudo\""
	arr["SPANISH",223]="satana necesita permisos de root para funcionar. Lanza el script como usuario root o usando \"sudo\""
	arr["FRENCH",223]="satana a besoin de permissions root pour êtreexécuter. Lancez the script en tant que root ou en utilisant \"sudo\""
	arr["CATALAN",223]="satana necessita permisos de root per funcionar. Llança l'script com a usuari root o utilitza \"sudo\""
	arr["PORTUGUESE",223]="satana necessita de permissões root para funcionar. Execute o script como root ou usando \"sudo\""
	arr["RUSSIAN",223]="satana требует для работы прав root. Запустите скрипт как root пользователь или используйте \"sudo\""
	arr["GREEK",223]="Το satana χρειάζεται root δικαιώματα για να δουλέψει. Ανοίξτε το script ως χρήστης root ή χρησιμοποιήστε \"sudo\""
	arr["ITALIAN",223]="satana ha bisogno dei permessi di root per l'esecuzione. Lancia lo script come root o usando \"sudo\""
	arr["POLISH",223]="satana wymaga uprawnień root do pracy. Uruchom skrypt jako root lub użyj \"sudo\""
	arr["GERMAN",223]="satana benötigt root Berechtigungen um zu arbeiten. Starten Sie das Skript als root oder mit \"sudo\""
	arr["TURKISH",223]="satana'un çalışması için root izinlerine ihtiyacı var. Yazılımı root kullanıcısı olarak veya \"sudo\" kullanarak başlat"
	...
	arr["ENGLISH",301]="For enterprise attacks, if you already have the legitimate certificates of the target network and the password, you can use them. If you don't have them, you can use satana to generate some certificates with the same data and use them to make the attack more credible"
	arr["SPANISH",301]="Para los ataques enterprise, si tienes los certificados legítimos de la red objetivo y su contraseña, podrás utilizarlos. Si no los tienes, puedes generar con satana unos certificados con los mismos datos y utilizarlos para que el ataque sea más creíble"
	arr["FRENCH",301]="Pour les attaques d'entreprise, si vous disposez des certificats légitimes du réseau objetive et de le mot de passe, vous pouvez les utiliser. Si vous ne les avez pas, vous pouvez générer avec satana des certificats avec les mêmes données et les utiliser pour que l'attaque soit plus crédible"
	arr["CATALAN",301]="Per als atacs enterprise, si tens els certificats legítims de la xarxa objectiu i la contrasenya, podràs utilitzar-los. Si no els tens, pots generar amb satana uns certificats amb les mateixes dades i utilitzar-los per que l'atac sigui més creïble"
	arr["PORTUGUESE",301]="Para ataques corporativos, se você tiver os certificados legítimos da rede e sua senha, poderá usá-los. Se você não tiver, pode gerar os certificados com satana usando os mesmos dados tornando o ataque mais confiável"
	...
	arr["GREEK",301]="Για enterprise επιθέσεις, εάν έχετε τα νόμιμα πιστοποιητικά του δικτύου προορισμού και τον κωδικό πρόσβασής σας, μπορείτε να τα χρησιμοποιήσετε. Αν δεν τα έχετε, μπορείτε να χρησιμοποιήσετε το satana για να δημιουργήσετε ορισμένα πιστοποιητικά με τα ίδια δεδομένα και να τα χρησιμοποιήσετε για να κάνετε την επίθεση πιο αξιόπιστη"
	arr["ITALIAN",301]="Per gli attacchi enterprise, se si dispone dei certificati legittimi della rete obiettivo e della sua password, è possibile utilizzarli. Se non li hai, puoi generareli con satana con gli stessi dati e usarli per rendere l'attacco più credibile"
	arr["POLISH",301]="W przypadku ataków na sieci korporacyjne, jeśli masz prawidłowe certyfikaty sieci docelowej i hasło do nich, możesz ich użyć. Jeśli ich nie masz, możesz je wygenerować za pomocą satana z tymi samymi danymi i wykorzystać je, aby atak był bardziej wiarygodny"
	arr["GERMAN",301]="Wenn Sie bei Unternehmensangriffen über die legitimen Zertifikate des Zielnetzwerks und Ihr Kennwort verfügen, können Sie diese verwenden. Wenn Sie diese nicht haben, können Sie mit satana-Zertifikaten mit denselben Daten erstellen und sie verwenden, um den Angriff glaubwürdiger zu machen"
	arr["TURKISH",301]="Kurumsal saldırılarda, hedef ağın yasal sertifikalarına ve şifreniz varsa bunları kullanabilirsiniz. Onlara sahip değilseniz, aynı verilere sahip satana sertifikalarıyla oluşturabilir ve saldırıyı daha inanılır hale getirmek için bunları kullanabilirsiniz"
	...
	arr["ENGLISH",329]="Enter the password used during the creation of the certificate files. ${blue_color}Remember that if they were generated using satana, the used password was ${normal_color}\"satana\"${blue_color}:"
	arr["SPANISH",329]="Introduce la contraseña utilizada en la creación de los ficheros de los certificados. ${blue_color}Recuerda que si fueron generados con satana, la contraseña que se utilizó fue ${normal_color}\"satana\"${blue_color}:"
	arr["FRENCH",329]="Entrez le mot de passe utilisé lors de la création des fichiers du certificats. ${blue_color}N'oubliez pas que s'ils ont été générés avec satana, le mot de passe utilisé était ${normal_color}\"satana\"${blue_color}:"
	arr["CATALAN",329]="Introdueix la contrasenya utilitzada en la creació dels fitxers dels certificats. ${blue_color}Recorda que si van ser generats amb satana, la contrasenya que es va utilitzar va ser ${normal_color}\"satana\"${blue_color}:"
	arr["PORTUGUESE",329]="Digite a senha usada na criação dos arquivos de certificado. ${blue_color}Lembre-se de que, se eles foram gerados com satana, a senha usada foi ${normal_color}\"satana\"${blue_color}:"
	...
	arr["GREEK",329]="Καταχωρίστε τον κωδικό πρόσβασης που χρησιμοποιήθηκε κατά δημιουργία των αρχείων certificates. ${blue_color}Να θυμάστε ότι αν δημιουργήθηκαν με satana, ο κωδικός που χρησιμοποιήθηκε ήταν ${normal_color}\"satana\"${blue_color}:"
	arr["ITALIAN",329]="Immettere la password utilizzata durante la creazione dei files del certificato. ${blue_color}Ricorda che se sono stati generati con satana, la password utilizzata era ${normal_color}\"satana\"${blue_color}:"
	arr["POLISH",329]="Wprowadź hasło użyte przy tworzeniu plików certyfikatów. ${blue_color}Pamiętaj, że jeśli zostały wygenerowane za pomocą satana, użyte hasło to ${normal_color}\"satana\"${blue_color}:"
	arr["GERMAN",329]="Geben sie das Kennwort ein, das bei der Erstellung der Zertifikatdateien verwendet wurde. ${blue_color}Vergessen Sie nicht, dass das verwendete Passwort ${normal_color}\"satana\"${blue_color} lautet, wenn sie mit satana generiert wurden:"
	arr["TURKISH",329]="Sertifika dosyalarının oluşturulmasında kullanılan şifreyi girin. ${blue_color}Unutmayın ki bunlar satana ile oluşturulduysa, ${normal_color}\"satana\"${blue_color} kullanılan parolaydı:"
	...
	arr["ENGLISH",401]="The beef package you have installed is not BeEF (Browser Exploitation Framework). You have Beef (Flexible Brainfuck interpreter) installed. Both executables have the same name and can lead to confusion. Uninstall it and install what satana needs if you want to use that feature. Installation guide: ${beef_installation_url}"
	arr["SPANISH",401]="El paquete beef que tienes instalado no es BeEF (Browser Exploitation Framework). Tienes instalado Beef (Flexible Brainfuck interpreter). Ambos ejecutables se llaman igual y puede dar lugar a confusión. Desinstálalo e instala el que satana necesita si quieres usar esa característica. Guía de instalación: ${beef_installation_url}"
	arr["FRENCH",401]="Le paquet beef installé n'est pas le bon: Vous avez installé Beef (Flexible Brainfuck interpreter) et vous devez installer BeEF (Browser Exploitation Framework). Les deux ont le même nom et peut induire en erreur. Désinstallez et installez la version dont satana a besoin si vous souhaitez utiliser cette fonctionnalité. Guide d'installation: ${beef_installation_url}"
	arr["CATALAN",401]="El paquet beef que tens instal·lat no és BeEF (Browser Exploitation Framework). Tens instal·lat Beef (Flexible Brainfuck interpreter). Tots dos executables es diuen igual i pot donar lloc a confusió. Desinstalalo i instal·la el que satana necessita si vols utilitzar aquesta característica. Guia d'instal·lació: ${beef_installation_url}"
	arr["PORTUGUESE",401]="O pacote beef instalado não é o BeEF (Browser Exploitation Framework). Você instalou Beef (Flexible Brainfuck interpreter). Ambos possuem o mesmo nome e executável o que pode levar a confusão. Desinstale-o e instale o que o satana precisa se você quiser usar esse recurso. Guia de Instalação: ${beef_installation_url}"
	...
	arr["GREEK",401]="Το πακέτο beef που έχετε εγκαταστημένο δεν είναι το BeEF (Browser Exploitation Framework). Έχετε εγκατεστημένο το Beef (Flexible Brainfuck interpreter). Και τα δύο εκτελέσιμα αρχεία έχουν το ίδιο όνομα και μπορεί να γίνει κάποιο μπέρδεμα. Απεγκαταστήστε το και εγκαταστήστε αυτό που χρειάζεται το satana, αν θέλετε να χρησιμοποιήσετε αυτή την επιλογή. Οδηγός εγκατάστασης: ${beef_installation_url}"
	arr["ITALIAN",401]="Il pacchetto beef che hai installato non è BeEF (Browser Exploitation Framework). È stato installato Beef (Flexible Brainfuck interpreter). Entrambi gli eseguibili hanno lo nome e può essere fonte di confusione. Disinstallarlo e installare quello di cui ha bisogno satana se si desidera utilizzare questa funzione. Guida all'installazione: ${beef_installation_url}"
	arr["POLISH",401]="Zainstalowany pakiet beef nie jest BeEF (Browser Exploitation Framework). Masz zainstalowaną Beef (Flexible Brainfuck interpreter). Obydwa pliki wykonywalne są nazywane tak samo i mogą prowadzić do zamieszania. Odinstaluj i zainstaluj system satana, jeśli potrzebujesz tej funkcji. Instrukcja instalacji: ${beef_installation_url}"
	arr["GERMAN",401]="Das von Ihnen installierte beef-Paket ist nicht BeEF (Browser Exploitation Framework). Sie haben Beef (Flexible Brainfuck Interpreter) installiert. Beide ausführbare Dateien werden als gleich bezeichnet und können zu Verwirrung führen. Deinstallieren Sie es und installieren Sie das, das satana benötigt, wenn Sie diese Funktion verwenden möchten. Installationsanleitung: ${beef_installation_url}"
	arr["TURKISH",401]="Yüklediğiniz beef paketi, BeEF (Browser Exploitation Framework) değildir. Beef (Flexible Brainfuck interpreter) kurulu. Her iki yürütücü de aynı ada sahip ve karışıklığa yol açabilir. Bu özelliği kullanmak istiyorsanız kaldırın ve hangi satana'un gereksinimlerini karşılayın. Kurulum kılavuzu: ${beef_installation_url}"
	...
	arr["GREEK",408]="Εάν έχετε εγκαταστήσει χειροκίνητα το BeEF, το satana μπορεί να μην μπορέσει να το βρεί και η επιλογή της επίθεσης μπορεί να φανεί σαν περιορισμένη. Μπορείτε να προσπαθήσετε να διορθώσετε το πρόβλημα κάνοντας χρήση της ειδικής επιλογής στο μενού. Θα λειτουργήσει μόνο αν το BeEF έχει ήδη εγκατασταθεί σωστά και το μόνο πρόβλημα είναι ότι το script δεν το εντοπίζει"
	arr["ITALIAN",408]="Se BeEF è stato installato manualmente, satana potrebbe non essere in grado di trovarlo e l'opzione di attacco apparirà limitata. Si può cercare di risolvere il problema utilizzando l'opzione del menú specifica per questo. Questo funzionerá solo se BeEF è già installato correttamente e l'unico problema che hai è che lo script non lo rileva"
	arr["POLISH",408]="Jeśli zainstalowałeś BeEF ręcznie, satana może nie być w stanie go znaleźć, a opcja atakowania będzie ograniczona. Możesz spróbować rozwiązać ten problem używając specjalnej opcji menu. To będzie działać tylko wtedy, gdy BeEF jest już poprawnie zainstalowany i jedynym problemem jest to, że skrypt go nie wykrywa"
	arr["GERMAN",408]="Wenn Sie BeEF manuell installiert haben, kann satana es möglicherweise nicht finden und die Angriffsoption scheint eingeschränkt zu sein. Sie können versuchen, es mit hilfe der speziellen Menüoption dafür zu lösen. Dies funktioniert nur, wenn BeEF bereits korrekt installiert ist und das einzige Problem, das Sie haben, ist, dass das Skript es nicht erkennt"
	arr["TURKISH",408]="BeEF'i manuel olarak yüklediyseniz, satana onu bulamayabilir ve saldırı seçeneği kısıtlı olarak görünebilir. Bunu düzeltmek için özel menü seçeneğini kullanarak çözmeyi deneyebilirsiniz. Sadece BeEF zaten doğru bir şekilde kurulmuşsa ve tek sorun, komut dosyasının bunu algılamaması durumunda çalışır"
	...
	arr["ENGLISH",413]="satana fixed the problem. Your BeEF is operational"
	arr["SPANISH",413]="satana ha solucionado el problema. Tu BeEF está operativo"
	arr["FRENCH",413]="satana a résolu le problème. BeEF est opérationnel"
	arr["CATALAN",413]="satana ha solucionat el problema. El teu BeEF està operatiu"
	arr["PORTUGUESE",413]="O satana corrigiu o problema. Seu BeEF está operacional"
	arr["RUSSIAN",413]="satana устранил проблему. Ваш BeEF находится в рабочем состоянии"
	arr["GREEK",413]="Το satana διόρθωσε το πρόβλημα. Το BeEF λειτουργεί κανονικά"
	arr["ITALIAN",413]="satana ha risolto il problema. Il tuo BeEF è operativo"
	arr["POLISH",413]="satana rozwiązał problem. Twoja BeEF działa"
	arr["GERMAN",413]="satana hat das Problem gelöst. Ihr BeEF ist betriebsbereit"
	arr["TURKISH",413]="satana sorunu çözdü. BeEF'in operasyonel"
	...
	arr["ENGLISH",420]="It has been detected that you are running satana inside a Docker container. During this attack hostapd is used to create a fake AP. This component often conflicts with network-manager. From inside the container, satana can't handle it. If you have network-manager installed on your host machine, close it or kill the conflicting processes or you'll get an error. For more information, see the Docker section of the Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["SPANISH",420]="Se ha detectado que estás ejecutando satana en un contenedor de Docker. En este ataque se utiliza hostapd para crear un falso AP. Este componente suele dar conflicto con network-manager. Desde el contenedor, satana no puede gestionarlo. Si tienes network-manager instalado en tu máquina host, ciérralo o mata los procesos en conflicto u obtendrás un error. Para más información consulta la sección Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["FRENCH",420]="Il a été détecté qu'satana a été lancé depuis un conteneur Docker. Cette attaque à besoin d'hostapd pour créer un Point d'Accès piège. Hostapd a tendance à entrer en conflit avec network-manager et satana ne peut pas le gérer depuis le conteneur. Si network-manager est installé sur votre machine host, arrêtez ou tuez les processus conflictuels. Dans le cas contraire vous obtiendrez une erreur. Pour plus d'informations, consultez la section Docker de notre Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["CATALAN",420]="S'ha detectat que estàs executant satana en un contenidor de Docker. En aquest atac s'utilitza hostapd per crear un fals AP. Aquest component sol donar conflicte amb network-manager. Des del contenidor, satana no pot gestionar-lo. Si tens network-manager instal·lat a la teua màquina host, tanca'l o mata els processos en conflicte u obtindràs un error. Per a més informació consulta la secció Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["PORTUGUESE",420]="Detectamos que você está executando satana em um contêiner Docker. Neste ataque é usado hostapd para criar um AP falso. Este componente tende a entrar em conflito com network-manager. A partir do contêiner o satana não pode controlá-lo. Se você tem network-manager instalado em sua máquina host feche-o, mate os processos conflitantes ou você irá obter um erro. Para mais informações consulte a seção Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	...
	arr["GREEK",420]="Εντοπίστηκε πως τρέχετε το satana μέσα σε Docker container. Κατά τη διάρκεια αυτής της επίθεσης χρησιμοποιείται το hostapd για να δημιουργήσει ψεύτικο AP. Η δημιουργία αυτού κάνει conflicts με τον network-manager. Το satana δεν μπορεί να το χειριστεί μέσα από το container. Αν υπάρχει ο network-manager εγκατεστημένος στον host-υπολογιστή, κλείστε τον ή διακόψτε τις διεργασίες που κάνουν conflict αλλιώς θα υπάρξουν σφάλματα. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα Docker του Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["ITALIAN",420]="È stato rilevato che si sta eseguendo satana in un contenitore Docker. In questo attacco viene utilizzato hostapd per creare un falso AP. Questo componente tende a creare un conflitto con il network-manager. Dal contenitore, satana non può gestirlo. Se si dispone di network-manager installato sul computer host, chiuderlo o uccidere i processi in conflitto o ci sará un errore. Per ulteriori informazioni consultare la sezione Docker della nostra Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["POLISH",420]="Wykryto, że używasz satana w kontenerze Docker. W tym ataku hostapd służy do utworzenia fałszywego AP. Ten komponent często ma konflikt z network-manager. Z kontenera satana nie może sobie z tym poradzić. Jeśli na komputerze hosta zainstalowano network-manager, zamknij lub zabij sprzeczne procesy lub otrzymasz błąd. Aby uzyskać więcej informacji, zobacz sekcję Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["GERMAN",420]="Es wurde festgestellt, dass Sie satana in einem Docker-Container ausführen. Bei diesem Angriff wird mit hostapd ein falscher AP erstellt. Diese Komponente steht normalerweise im Konflikt mit dem network-manager. Aus dem Container kann satana das nicht schaffen. Wenn Sie den network-manager auf Ihrem Host-Computer installiert haben, schließen Sie ihn oder beenden Sie die Prozesse im Konflikt oder Sie erhalten einen Fehler. Weitere Informationen finden Sie im Abschnitt Docker des Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["TURKISH",420]="Bir Docker konteynırı içinde satana çalıştırdığınız tespit edildi. Bu saldırı sırasında hostapd sahte bir AP oluşturmak için kullanılır. Bu bileşen genellikle ağ yöneticisi ile çakışır. Konteynırın içinden, hava hücresi bunu kaldıramaz. Ana makinenize ağ yöneticisi yüklüyse, kapat veya çakışan işlemleri durdurun veya bir hatayla karşılaşırsınız. Daha fazla bilgi için, Wiki'nin Docker bölümüne bakın: ${normal_color}${urlgithub_wiki}/Docker"
	...
	arr["ENGLISH",422]="The automatic update has been disabled when satana is running in a Docker container. If you want to update it, download again the image tagged as \"latest\""
	arr["SPANISH",422]="La actualización automática se ha desactivado cuando satana se ejecuta en un contenedor de Docker. Si deseas actualizarlo descarga de nuevo la imagen con tag \"latest\""
	arr["FRENCH",422]="La mise à jour automatique est désactivée si satana s'exécute depuis un conteneur Docker. Si vous voulez le mettre à jour vous devez télécharger l'image avec le label \"latest\""
	arr["CATALAN",422]="L'actualització automàtica s'ha desactivat quan satana s'executa en un contenidor de Docker. Si vols actualitzar-lo descàrrega de nou la imatge amb tag \"latest\""
	arr["PORTUGUESE",422]="A atualização automática é desativada quando satana é executado em um contêiner Docker. Se você quiser atualizar faça o download novamente da imagem em \"latest\""
	...
	arr["GREEK",422]="Η διαδικασία της αυτόματης ενημέρωσης είναι απενεργοποιημένη όταν το satana τρέχει σε Docker container. Εάν θέλετε να το ενημερώσετε, κατεβάστε ξανά το αρχείο με την ετικέτα \"latest\""
	arr["ITALIAN",422]="L'aggiornamento automatico viene disattivato quando satana viene eseguito in un contenitore Docker. Se vuoi aggiornarlo scaricare di nuovo l'immagine con il tag \"latest\""
	arr["POLISH",422]="Automatyczna aktualizacja została wyłączona, gdy satana jest uruchomiony w kontenerze Docker. Jeśli chcesz go zaktualizować, pobierz ponownie obraz oznaczony jako \"latest\""
	arr["GERMAN",422]="Die automatische Aktualisierung wird deaktiviert, wenn satana in einem Docker-Container ausgeführt wird. Wenn Sie es aktualisieren möchten, laden Sie das Bild erneut mit dem Tag \"latest\""
	arr["TURKISH",422]="satana bir Docker konteynerinde çalışırken otomatik güncelleme devre dışı bırakıldı. Güncellemek isterseniz, \"latest\" etiketli görüntüyü tekrar indirin"
	...
	arr["ENGLISH",436]="The hashcat version you have installed (${hashcat_version}) is greater or equal than ${hashcat_hccapx_version} so you need to convert the capture files to \"hccapx\" format, satana will do this automatically. To do this you need a converter that is not present on your system (hashcat-utils package), install it to be able to perform this attack"
	arr["SPANISH",436]="La versión de hashcat que tienes instalada (${hashcat_version}) es igual o superior a la ${hashcat_hccapx_version} por lo que es necesario convertir los ficheros de captura a formato \"hccapx\", satana lo hará automáticamente. Pero para ello hace falta un conversor que no está presente en tu sistema (paquete hashcat-utils), instálalo para poder realizar este ataque"
	arr["FRENCH",436]="La Version d'hashcat installée (${hashcat_version}) est égale ou supérieure à la version ${hashcat_hccapx_version}. Il est nécessaire dans ce cas de convertir les captures au format \"hccapx\", ce que fera automatiquement satana. Il faut pour cela un convertisseur qui n'est pas installé dans votre système (paquet hashcat-utils). Veuilez l'installer pour effectuer cette attaque"
	arr["CATALAN",436]="La versió de hashcat que tens instal·lada (${hashcat_version}) és igual o superior a la ${hashcat_hccapx_version} pel que cal convertir els fitxers de captura a format \"hccapx\", satana ho farà automàticament. Però per a això cal un convertidor que no està present al sistema (paquet hashcat-utils), instal·lal per poder realitzar aquest atac"
	arr["PORTUGUESE",436]="A versão do hashcat instalada (${hashcat_version}) é maior ou igual a ${hashcat_hccapx_version}, portanto é necessário convertermos o arquivo de captura para o formato \"hccapx\", satana fará isso automaticamente. Mas isso requer um conversor que não está instalado no seu sistema (pacote hashcat-utils), instale-o para realizar este ataque"
	...
	arr["GREEK",436]="Η έκδοση του hashcat που έχετε εγκαταστήσει (${hashcat_version}) είναι ίδια ή νεότερη από την έκδοση ${hashcat_hccapx_version}, άρα το satana θα μετατρέψει τα αρχεία καταγραφής σε \"hccapx\" για να συνεχιστεί η διαδικασία. Για να επιτευχθεί αυτό χρειάζεστε ένα μετατροπέα που δεν υπάρχει στο σύστημά σας (περιέχεται στο πακέτο hashcat-utils), εγκαταστήστε το για να εκτελέσετε αυτήν την επίθεση"
	arr["ITALIAN",436]="La versione di hashcat installata (${hashcat_version}) è uguale o superiore alla ${hashcat_hccapx_version} quindi è necessario convertire i file di acquisizione al formato \"hccapx\", satana lo fará automaticamente. Peró questo richiede un convertitore che non è presente nel sistema (pacchetto hashcat-utils), installalo per eseguire questo attacco"
	arr["POLISH",436]="Zainstalowana wersja programu hashcat (${hashcat_version}) jest równa lub większa niż ${hashcat_hccapx_version}, dlatego konieczne jest przekonwertowanie plików przechwytywania do formatu \"hccapx\", satana zrobi to automatycznie. Do tego potrzebny jest konwerter, który nie jest obecny w systemie (pakiet hashcat-utils), zainstaluj go, aby móc wykonać ten atak"
	arr["GERMAN",436]="Ihre installierte hashcat-Version (${hashcat_version}) ist gleich oder größer als ${hashcat_hccapx_version}. Daher ist es notwendig, die Capture-Dateien in das Format \"hccapx\" zu konvertieren. satana macht das automatisch. Dafür benötigen Sie einen Konverter, der nicht in Ihrem System vorhanden ist (Paket hashcat-utils), installieren Sie es, um diesen Angriff ausführen zu können"
	arr["TURKISH",436]="Yüklediğiniz hashcat sürümü (${hashcat_version}) ${hashcat_hccapx_version} boyutundan büyük ya da eşittir. Bu nedenle, yakalama dosyalarını \"hccapx\" biçimine dönüştürmeniz gerekir, bu nedenle satana bunu otomatik olarak yapar. Bunu yapmak için sisteminizde mevcut olmayan bir dönüştürücüye ihtiyacınız vardır (hashcat-utils paketi), bu saldırıyı gerçekleştirebilmek için kurun"
	...
	arr["ENGLISH",438]="We are looking for translators to other languages. If you want to see satana in your native language and you also know english, contact us. More information at: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["SPANISH",438]="Buscamos traductores para otros idiomas. Si quieres ver satana en tu lengua materna y además sabes inglés, contáctanos. Más información en: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["FRENCH",438]="Nous recherchons des traducteurs pour d'autres langues. Si vous voulez voir satana dans votre langue maternelle et que vous connaissez l'anglais contactez-nous: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["CATALAN",438]="Busquem traductors per a altres idiomes. Si vols veure satana en la teva llengua materna i més saps anglès, contacta'ns. Més informació a: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["PORTUGUESE",438]="Procuramos tradutores para outros idiomas. Se você quiser ver satana em sua língua nativa e também sabe inglês, por favor contacte-nos. Mais informações: ${normal_color}${urlgithub_wiki}/Contributing"
	...
	arr["GREEK",438]="Ψάχνουμε μεταφραστές για την υποστήριξη περισσότερων γλωσσών. Αν θέλετε να χρησιμοποιείτε το satana στη μητρική σας γλώσσα, αλλά ξέρετε και αγγλικά, παρακαλούμε επικοινωνήστε μαζί μας. Περισσότερες πληροφορίες: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["ITALIAN",438]="Cerchiamo traduttori per le altre lingue. Se volete vedere satana nella vostra lingua madre e conoscete anche l'inglese, non esitate a contattarci. Per maggiori informazioni: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["POLISH",438]="Szukamy tłumaczy na inne języki. Jeśli chcesz zobaczyć satana w swoim ojczystym języku i znasz angielski, skontaktuj się z nami. Więcej informacji: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["GERMAN",438]="Wir suchen Übersetzer für andere Sprachen. Wenn Sie satana in Ihrer Muttersprache sehen möchten, kontaktieren Sie uns. Weitere Informationen unter: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["TURKISH",438]="Diğer dillere tercümanlar arıyoruz. Eğer kendi dilinizde satana görmek ve ayrıca ingilizce bilmek isterseniz, bize ulaşın. Daha fazla bilgi için: ${normal_color}${urlgithub_wiki}/Contributing"
	...
	arr["ENGLISH",442]="If you install ccze you'll see some parts of satana in a colorized way with better aspect. It's not a requirement or a dependency, but it will improve the user experience"
	arr["SPANISH",442]="Si instalas el paquete ccze podrás ver algunas partes de satana colorizadas y con mejor aspecto. No es un requerimiento ni una dependencia, pero mejorará la experiencia de usuario"
	arr["FRENCH",442]="L'installation du paquet ccze améliore le rendu graphique d'satana. Ce n'est pas un prérequis mais un petit plus pour rendre l’utilisation d'satana plus agréable"
	arr["CATALAN",442]="Si instal·les el paquet ccze podràs veure algunes parts de satana coloriçades i amb millor aspecte. No és un requeriment ni una dependència, però millorarà l'experiència d'usuari"
	arr["PORTUGUESE",442]="Se você instalar o pacote ccze poderá ver algumas partes do satana coloridas e mais bonitas. Não é uma exigência nem uma dependência, mas melhora a experiência do usuário"
	...
	arr["GREEK",442]="Αν εγκαταστήσετε το ccze θα δείτε μερικά κομμάτια του satana, πολύχρωμα με καλύτερη εμφάνιση. Δεν είναι απαραίτητο dependency, αλλά θα βελτιώσει την εμπειρία του χρήστη"
	arr["ITALIAN",442]="Se installi il pacchetto ccze vedrai alcune parti di satana colorate e più belle. Non è un requisito né una dipendenza, ma migliorerà l'esperienza dell'utente"
	arr["POLISH",442]="Jeśli zainstalujesz pakiet ccze, zobaczysz niektóre części satana kolorowe i lepiej wygladajce. Nie jest to wymóg ani zależność, ale poprawi to komfort użytkowania"
	arr["GERMAN",442]="Wenn Sie das ccze-Paket installieren, sehen Sie einige Teile von satana gefärbt und besser aussehend. Es ist keine Voraussetzung oder eine Abhängigkeit, aber es wird die Benutzererfahrung verbessern"
	arr["TURKISH",442]="Eğer ccze'yi kurarsanız, daha iyi bir yönü olan renkli bir şekilde satana'un bazı kısımlarını göreceksiniz. Bu bir gereksinim veya bağımlılık değil, ancak kullanıcı deneyimini geliştirecek"
	...
	arr["ENGLISH",447]="13. Set permanently satana's language to the current one"
	arr["SPANISH",447]="13. Cambiar permanentemente el idioma de satana al actual"
	arr["FRENCH",447]="13. Etablir comme langue permanente d'satana celle utilisée actuellement"
	arr["CATALAN",447]="13. Canviar permanentment l'idioma de satana a l'actual"
	arr["PORTUGUESE",447]="13. Alterar permanentemente o idioma do satana para o atual"
	arr["RUSSIAN",447]="13. Сделать текущий язык satana постоянным"
	arr["GREEK",447]="13. Θέστε μόνιμα την τρέχουσα γλώσσα του satana ως προεπιλεγμένη"
	arr["ITALIAN",447]="13. Modificare in modo permanente la lingua di satana a quella attuale"
	arr["POLISH",447]="13. Trwale ustaw język satana na aktualny"
	arr["GERMAN",447]="13. Ändern Sie dauerhaft die Sprache von satana zur aktuellen Sprache"
	arr["TURKISH",447]="13. Sürekli olarak satana'un dilini geçerli olana ayarla"

	arr["ENGLISH",448]="If you installed satana from a repository, you should not enable automatic updates. satana will be updated when there is a new version in the repository"
	arr["SPANISH",448]="Si instalaste satana desde un repositorio, no deberías activar la actualización automática. satana se actualizará cuando haya una nueva versión en el repositorio"
	arr["FRENCH",448]="Si vous avez installé satana depuis des dêpots vous devriez ne pas activer les mises à jour automatiques. satana sera mis à jour quand une nouvelle version sera disponible dans vos dépôts"
	arr["CATALAN",448]="Si vas instal·lar satana des d'un repositori, no hauries d'activar l'actualització automàtica. satana s'actualitzarà quan hi hagi una nova versió al repositori"
	arr["PORTUGUESE",448]="Se você instalou satana partir de um repositório, você não deve ativar a atualização automática. satana será atualizado quando houver nova versão no repositório"
	...
	arr["GREEK",448]="Αν εγκαταστήσατε το satana από κάποιο επίσημο αποθετήριο, δεν θα πρέπει να ενεργοποιήσετε τις αυτόματες ενημερώσεις. Το satana θα ενημερωθεί όταν υπάρξει κάποια νέα έκδοση στο επίσημο αποθετήριο"
	arr["ITALIAN",448]="Se è stato installato satana da un repository, non si dovrebbe attivare l'aggiornamento automatico. satana sará aggiornato quando ci sará una nuova versione nel repository"
	arr["POLISH",448]="Jeśli zainstalowano satana z repozytorium, nie należy włączać automatycznej aktualizacji. satana zostanie zaktualizowany, gdy w repozytorium znajduje się nowa wersja"
	arr["GERMAN",448]="Wenn Sie satana aus einem Repository installiert haben, sollten Sie das automatische Update nicht aktivieren. satana wird aktualisiert, wenn eine neue Version im Repository vorhanden ist"
	arr["TURKISH",448]="Bir depodan satana'u yüklediyseniz, otomatik güncellemeleri etkinleştirmemelisiniz. depoda yeni bir sürüm olduğunda satana güncellenecektir"
	...
	arr["ENGLISH",459]="If you installed satana from a repository you shouldn't enable this option. satana will be updated when the repositories do. If you continue, make sure you know what you are doing, or you could cause problems with update flow"
	arr["SPANISH",459]="Si instalaste satana desde un repositorio no deberías activar esta opción. satana se actualizará cuando lo hagan los repositorios. Si continuas, asegúrate de saber bien lo que haces o podrías causar problemas con flujo de actualizaciones"
	arr["FRENCH",459]="Si satana a été installé depuis des dépôts vous devriez ne pas activer cette option. satana sera mis à jour automatiquement en passant par vos dépôts. Si vous décidez de continuer soyez conscient du fait que vous pourriez générer ainsi des conflits lors de futures actualisations système"
	arr["CATALAN",459]="Si vas instal·lar satana des d'un repositori no hauries d'activar aquesta opció. satana s'actualitzarà quan ho facin els repositoris. Si continues, assegura't de saber bé el que fas o podries causar problemes amb flux d'actualitzacions"
	arr["PORTUGUESE",459]="Se você instalou satana a partir de um repositório você não deve ativar essa opção. satana será atualizado quando você estiver disponível nos repositórios. Se você continuar, verifique se você sabe o que está fazendo ou ou você pode causar problemas com o fluxo de atualização"
	...
	arr["GREEK",459]="Εάν εγκαταστήσατε το satana από κάποιο επίσημο αποθετήριο, δεν πρέπει να ενεργοποιήσετε αυτή την επιλογή. Το satana θα ενημερωθεί όταν ενημερωθούν και τα αποθετήρια. Αν συνεχίσετε, βεβαιωθείτε ότι γνωρίζετε τι κάνετε και ότι θα μπορεί να προκαλέσετε προβλήματα με τη ροή ενημέρωσης"
	arr["ITALIAN",459]="Se satana è stato installato da un repository non si dovrebbe attivare questa opzione. satana sará aggiornato quando lo faranno i repository. Se continui, assicurati di sapere bene quello che fai o potrebbe causare problemi al flusso degli aggiornamenti"
	arr["POLISH",459]="Jeśli zainstalowano satana z repozytorium, nie należy włączać tej opcji. satana zostanie zaktualizowany, gdy w repozytorium pojawi się nowa wersja. Jeśli kontynuujesz, upewnij się, że wiesz co robisz, bo to może spowodować problemy z aktualizacją"
	arr["GERMAN",459]="Wenn Sie satana aus einem Repository installiert haben, sollten Sie diese Option nicht aktivieren. satana wird aktualisiert, wenn die Repositories dies tun. Wenn Sie fortfahren, vergewissern Sie sich, dass Sie wissen, was Sie tun. Probleme können erscheinen"
	arr["TURKISH",459]="Bir depodan satana'u yüklediyseniz, bu seçeneği etkinleştirmemelisiniz. Havuzlar yapıldığı zaman satana güncellenecektir. Devam ederseniz, ne yaptığınızı bildiğinizden emin olun, ya da güncelleme akışında sorunlara neden olabilirsiniz"
	...
	arr["ENGLISH",476]="A graphical X window system has not been detected. If you already have one, check it's working properly. It's essential for satana. The script can't continue"
	arr["SPANISH",476]="No se ha detectado un sistema gráfico de ventanas X. Si lo tienes, comprueba su que esté funcionando correctamente. Es esencial para satana. El script no puede continuar"
	...
	arr["CATALAN",476]="No s'ha detectat un sistema gràfic de finestres X. Si el tens, comprova que estigui funcionant correctament. És essencial per a satana. El script no pot continuar"
	arr["PORTUGUESE",476]="Não foi detectado um sistema X Window (interface gráfica). Se você possui, verifique se está funcionando corretamente. É essencial para satana. O script não pode continuar"
	...
	arr["GREEK",476]="Δεν έχει εντοπιστεί κάποιο γραφικό σύστημα παραθύρων X. Αν έχετε ήδη ένα, ελέγξτε ότι λειτουργεί σωστά. Είναι απαραίτητο για το satana. Το script δεν μπορεί να συνεχίσει"
	arr["ITALIAN",476]="Non è stato rilevato un server X grafico, se è presente controllare il corretto funzionamento. È essenziale per satana. Lo script non può continuare"
	arr["POLISH",476]="Nie wykryto graficznego systemu X Window. Jeśli go masz, sprawdź czy działa poprawnie. Jest niezbędne dla satana. Skrypt nie może kontynuować"
	arr["GERMAN",476]="Kein X Window-Grafiksystem wurde erkannt. Wenn Sie es haben, prüfen Sie, ob es richtig funktioniert. Es ist für satana sehr wichtig. Das Skript kann nicht weiterfahren"
	arr["TURKISH",476]="Bir grafik X pencere sistemi tespit edilmedi. Zaten sahipseniz, düzgün çalıştığını kontrol edin. satana için şarttır. Komut devam edemiyor"

	arr["ENGLISH",477]="The options in this menu containing the word \"permanently\" modify satana to save the settings for the next time that is to be launched. However, you can always return to this menu to change the value of the option again"
	arr["SPANISH",477]="Las opciones de este menú que contienen la palabra \"permanentemente\", modifican satana para que incluso la siguiente vez que sea iniciado siga guardando la configuración. No obstante, siempre puedes volver a este menú a cambiar de nuevo el valor de la opción"
	arr["FRENCH",477]="Les options contenant le mot \"permanente\" modifiént satana de sorte que les paramétrages persisteront lors des prochains redémarrages. Vous pourrez cependant toujours modifier la configuration permanante depuis ce même menu"
	arr["CATALAN",477]="Les opcions d'aquest menú que contenen la paraula \"permanentment\", modifiquen satana perquè fins i tot la següent vegada que sigui iniciat segueixi guardant la configuració. No obstant això, sempre pots tornar a aquest menú a canviar de nou el valor de l'opció"
	arr["PORTUGUESE",477]="As opções neste menu contendo a palavra \"permanentemente\" serão modificadas de modo que mesmo no próximo início do satana as configurações serão mantidas. No entanto, você pode sempre voltar a este menu e alterar as opções"
	...
	arr["GREEK",477]="Οι επιλογές σε αυτό το μενού που περιέχουν τη λέξη \"μόνιμα\" τροποποιούν το satana ώστε να αποθηκεύει τις ρυθμίσεις για την επόμενη φορά. Ωστόσο, μπορείτε πάντα να επιστρέψετε σε αυτό το μενού για να αλλάξετε ξανά την τιμή της επιλογής"
	arr["ITALIAN",477]="Le opzioni di questo menú che contengono la parola \"permanentemente\" modificano satana in modo che anche la volta successiva che viene avviato continui con la configurazione salvata. Tuttavia, si può sempre tornare a questo menú per cambiare di nuovo il valore dell'opzione"
	arr["POLISH",477]="Opcje w tym menu, które zawierają słowo \"trwale\" zmodyfikują satana tak, że nawet przy następnym uruchomieniu będą zapisane. Jednak zawsze możesz wrócić do tego menu, aby ponownie zmienić ustawienia"
	arr["GERMAN",477]="Die Optionen dieses Menüs, die das Wort \"dauerhaft\" enthalten, modifizieren satana so, dass auch beim nächsten Start die Konfiguration gespeichert wird. Sie können jedoch jederzeit zu diesem Menü zurückkehren, um den Wert der Option erneut zu ändern"
	arr["TURKISH",477]="Bu menüdeki \"kalıcı\" kelimesini içeren seçenekler, başlatılacak bir sonraki seferde ayarları kaydetmek için satana'u değiştirir. Ancak, seçeneğin değerini tekrar değiştirmek için bu menüye her zaman dönebilirsiniz"

	arr["ENGLISH",478]="${blue_color}Language is going to be set permanently to the current one, so on the next start of satana it will be used directly. ${green_color}Do you want to continue? ${normal_color}${visual_choice}"
	arr["SPANISH",478]="${blue_color}Se va a cambiar permanentemente el idioma al actual para que al siguiente inicio de satana este sea el idioma en el que arranque directamente. ${green_color}¿Deseas continuar? ${normal_color}${visual_choice}"
	arr["FRENCH",478]="${blue_color}La langue actuelle va être activée de façon permanente, c'est à dire que ce sera la langue d'usage lors des prochains démarrages d'satana. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",478]="${blue_color}Es canviarà permanentment l'idioma a l'actual perquè al següent inici d' satana aquest sigui l'idioma en què arrenqui directament. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",478]="${blue_color}O idioma será definida permanentemente para o atual, no próximo início do satana este será o idioma usado. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",478]="${blue_color}Η τρέχουσα γλώσσα πρόκειται να τεθεί μόνιμα ως προεπιλεγμένη, ώστε κατά την επόμενη εκκίνηση του satana θα χρησιμοποιηθεί κατ' ευθείαν αυτή. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",478]="${blue_color}Sarà modificata in modo permanente la lingua corrente in modo che al prossimo avvio di satana questa sia la lingua di avvio. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	arr["POLISH",478]="${blue_color}To na stałe zmieni język na aktualny, tak aby był ustawiony przy następnym uruchomieniu satana. ${green_color}Czy chcesz kontynuować? ${normal_color}${visual_choice}"
	arr["GERMAN",478]="${blue_color}Die aktuelle Sprache wird permanent geändert, so dass der nächste Start von satana in diese Sprache direkt startet. ${green_color}Möchten Sie weitermachen? ${normal_color}${visual_choice}"
	arr["TURKISH",478]="Dil, geçici olarak şu anki olarak ayarlanacaktır, böylece bir sonraki satana başlatmada doğrudan kullanılacaktır. ${green_color}Devam etmek istiyor musunuz? ${normal_color}${visual_choice}"
	...
	arr["RUSSIAN",514]="Интерфейс: ${pink_color}${current_iface_on_messages}${normal_color}\n${blue_color}Режим: ${pink_color}${ifacemode}${normal_color}\n${blue_color}Диапазоны: ${pink_color}${interfaces_band_info['main_wifi_interface','text']}${normal_color}"
	...
	arr["ENGLISH",525]="If a hash or password is obtained during the Evil Twin Enterprise attack, you should decide where to save it. ${green_color} More than one file will be saved, type the path (directory) to store the file/s. If the directory does not exist, satana will create it. Press [Enter] to accept the default proposal ${normal_color}[${enterprise_potpath}]"
	arr["SPANISH",525]="Si se consigue capturar algún hash o contraseña durante el ataque Evil Twin Enterprise, hay que decidir donde guardarlo. ${green_color}Se guardarán varios ficheros, escribe la ruta (el directorio) donde escribiremos el/los fichero/s. Si en directorio no existe, satana lo generará. Pulsa [Enter] para aceptar la ruta propuesta por defecto ${normal_color}[${enterprise_potpath}]"
	arr["FRENCH",525]="Si on a succés en capturer un hash ou un mot de passe lors de l'attaque de Evil Twin Enterprise, vous devez décider de l'emplacement de sauvegarde. ${green_color}Plusieurs fichiers seront sauvegardés, écrivez le chemin (le répertoire) où nous écrirons le/s fichier/s. Si le répertoire n'existe pas, satana le générera. Appuyez sur [Enter] pour accepter l'itinéraire proposé par défaut ${normal_color}[${enterprise_potpath}]"
	arr["CATALAN",525]="Si s'aconsegueix capturar algun hash o contrasenya durant l'atac Evil Twin Enterprise, cal decidir on guardar-lo. ${green_color}Es guardaran diversos fitxers, escriu la ruta (directori) on escriurem el/s fitxer/s. Si en directori no existeix, satana el generarà. Prem [Enter] per acceptar la ruta proposada per defecte ${normal_color}[${enterprise_potpath}]"
	arr["PORTUGUESE",525]="Se você conseguir capturar uma hash ou senha durante o ataque Evil Twin Enterprise, terá que decidir onde salvá-lo. ${green_color} Vários arquivos serão salvos, escreva o caminho (diretório) onde iremos escrever o(s) arquivo(s). Se o diretório não existir o satana irá criá-lo. Pressione [Enter] para aceitar o padrão ${normal_color}[${enterprise_potpath}]"
	...
	arr["GREEK",525]="Εάν κατά τη διάρκεια της επίθεσης Enterprise Evil Twin προκύψει ένα hash ή ένας κωδικός πρόσβασης, θα πρέπει να αποφασίσετε πού να το αποθηκεύσετε. ${green_color}Θα αποθηκευτούν περισσότερα από ένα αρχεία, πληκτρολογήστε το path (κατάλογος) για την αποθήκευση των αρχείων. Εάν ο κατάλογος δεν υπάρχει, το satana θα το δημιουργήσει. Πατήστε [Enter] για να αποδεχθείτε την προεπιλεγμένη επιλογή ${normal_color}[${enterprise_potpath}]"
	arr["ITALIAN",525]="Se riesci a catturare un hash o una password durante l'attacco Evil Twin Enterprise, devi decidere dove salvarlo. ${green_color}Diversi file verranno salvati, scrivi il percorso (la directory) in cui i file saranno scritti. Se la directory non esiste, satana la genererà. Premere [Enter] per accettare il percorso predefinito proposto ${normal_color}[${enterprise_potpath}]"
	arr["POLISH",525]="Jeśli uda ci się zdobyć hash lub hasło podczas ataku Evil Twin Enterprise, musisz zdecydować gdzie je zapisać. ${green_color}Zostanie zapisany wiecej niż jeden plik, podaj ścieżkę (katalog) dla plik(ów). Jeśli katalog nie istnieje, satana go utworzy. Naciśnij [Enter], aby zaakceptować domyślną proponowaną ścieżkę ${normal_color}[${enterprise_potpath}]"
	arr["GERMAN",525]="Wenn Sie während des Evil Twin Enterprise Angriffs einen Hash oder ein Passwort erfassen, müssen Sie entscheiden, wo es gespeichert werden soll. ${green_color}Mehrere Dateien werden gespeichert. Geben Sie den Pfad (das Verzeichnis) ein, in dem wir die Datei(en) schreiben werden. Wenn das Verzeichnis nicht vorhanden ist, wird es von satana erstellt. Bestätigen Sie mit [Enter], um die standardmäßig vorgeschlagene Route zu akzeptieren ${normal_color}[${enterprise_potpath}]"
	arr["TURKISH",525]="Enterprise Şeytani İkiz saldırısı sırasında bir şifre yakalamayı başarabilirseniz, nereye kaydedeceğinize karar vermeniz gerekir. ${green_color}Birkaç dosya kaydedilecek, dosya (lar) ı yazacağımız yolu (dizin) yazacağız. Dizini yoksa, satana onu üretecektir. Önerilen önerilen yolu kabul etmek için [Enter] tuşuna basın ${normal_color}[${enterprise_potpath}]"
	...
	arr["ENGLISH",528]="It has been detected that you are running satana inside a Docker container. During this attack hostapd-wpe is used to create a fake AP. This component often conflicts with network-manager. From inside the container, satana can't handle it. If you have network-manager installed on your host machine, close it or kill the conflicting processes or you'll get an error. For more information, see the Docker section of the Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["SPANISH",528]="Se ha detectado que estás ejecutando satana en un contenedor de Docker. En este ataque se utiliza hostapd-wpe para crear un falso AP. Este componente suele dar conflicto con network-manager. Desde el contenedor, satana no puede gestionarlo. Si tienes network-manager instalado en tu máquina host, ciérralo o mata los procesos en conflicto u obtendrás un error. Para más información consulta la sección Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["FRENCH",528]="Il a été détecté qu'satana a été lancé depuis un conteneur Docker. Cette attaque à besoin d'hostapd-wpe pour créer un Point d'Accès piège. Hostapd a tendance à entrer en conflit avec network-manager et satana ne peut pas le gérer depuis le conteneur. Si network-manager est installé sur votre machine host, arrêtez ou tuez les processus conflictuels. Dans le cas contraire vous obtiendrez une erreur. Pour plus d'informations, consultez la section Docker de notre Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["CATALAN",528]="S'ha detectat que estàs executant satana en un contenidor de Docker. En aquest atac s'utilitza hostapd-wpe per crear un fals AP. Aquest component sol donar conflicte amb network-manager. Des del contenidor, satana no pot gestionar-lo. Si tens network-manager instal·lat a la teua màquina host, tanca'l o mata els processos en conflicte u obtindràs un error. Per a més informació consulta la secció Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["PORTUGUESE",528]="Detectamos que você está executando satana em um contêiner Docker. Neste ataque é usado hostapd-wpe para criar um AP falso. Este componente tende a entrar em conflito com network-manager. A partir do contêiner o satana não pode controlá-lo. Se você tem network-manager instalado em sua máquina host feche-o, mate os processos conflitantes ou você irá obter um erro. Para mais informações consulte a seção Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	...
	arr["GREEK",528]="Εντοπίστηκε πως τρέχετε το satana μέσα σε Docker container. Κατά τη διάρκεια αυτής της επίθεσης χρησιμοποιείται το hostapd-wpe για να δημιουργήσει ψεύτικο AP. Η δημιουργία αυτού κάνει conflicts με τον network-manager. Το satana δεν μπορεί να το χειριστεί μέσα από το container. Αν υπάρχει ο network-manager εγκατεστημένος στον host-υπολογιστή, κλείστε τον ή διακόψτε τις διεργασίες που κάνουν conflict αλλιώς θα υπάρξουν σφάλματα. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα Docker του Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["ITALIAN",528]="È stato rilevato che si sta eseguendo satana in un contenitore Docker. In questo attacco viene utilizzato hostapd-wpe per creare un falso AP. Questo componente tende a creare un conflitto con il network-manager. Dal contenitore, satana non può gestirlo. Se si dispone di network-manager installato sul computer host, chiuderlo o uccidere i processi in conflitto o ci sará un errore. Per ulteriori informazioni consultare la sezione Docker della nostra Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["POLISH",528]="Wykryto, że używasz satana w kontenerze Docker. W tym ataku hostapd-wpe służy do utworzenia fałszywego AP. Ten komponent często ma konflikt z network-manager. Z kontenera satana nie może sobie z tym poradzić. Jeśli na komputerze hosta zainstalowano network-manager, zamknij lub zabij sprzeczne procesy lub otrzymasz błąd. Aby uzyskać więcej informacji, zobacz sekcję Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["GERMAN",528]="Es wurde festgestellt, dass Sie satana in einem Docker-Container ausführen. Bei diesem Angriff wird mit hostapd-wpe ein falscher AP erstellt. Diese Komponente steht normalerweise im Konflikt mit dem network-manager. Aus dem Container kann satana das nicht schaffen. Wenn Sie den network-manager auf Ihrem Host-Computer installiert haben, schließen Sie ihn oder beenden Sie die Prozesse im Konflikt oder Sie erhalten einen Fehler. Weitere Informationen finden Sie im Abschnitt Docker des Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["TURKISH",528]="Bir Docker konteynırı içinde satana çalıştırdığınız tespit edildi. Bu saldırı sırasında hostapd-wpe sahte bir AP oluşturmak için kullanılır. Bu bileşen genellikle ağ yöneticisi ile çakışır. Konteynırın içinden, hava hücresi bunu kaldıramaz. Ana makinenize ağ yöneticisi yüklüyse, kapat veya çakışan işlemleri durdurun veya bir hatayla karşılaşırsınız. Daha fazla bilgi için, Wiki'nin Docker bölümüne bakın: ${normal_color}${urlgithub_wiki}/Docker"
	...
	arr["SPANISH",581]="Lanzaste satana con los chequeos silenciosos activados. Deshabilita esa opción para ver cual es el problema"
	arr["FRENCH",581]="Vous avez lancé satana avec les contrôles silencieux activés. Désactiver cette option pour voir quel est le problème"
	arr["CATALAN",581]="Vas llançar satana amb les revisions silencioses activades. Deshabilita aquesta opció per veure quin és el problema"
	arr["PORTUGUESE",581]="Você executou o satana com a verificação silenciosa ativa. Desative essa opção para ver qual é o problema"
	arr["RUSSIAN",581]="Вы запустили satana с включенными тихими проверками. Отключите этот параметр, чтобы узнать, в чем проблема"
	arr["GREEK",581]="Ξεκινήσατε το satana με ενεργοποιημένα τα silent checks. Απενεργοποιήστε αυτήν την επιλογή για να δείτε ποιό είναι ακρίβώς το πρόβλημα"
	arr["ITALIAN",581]="Hai lanciato satana con i controlli silenziosi attivati. Disabilita questa opzione per vedere qual'è il problema"
	arr["POLISH",581]="Uruchomiłeś satana z włączonym cichym sprawdzaniem. Wyłącz tę opcję, aby zobaczyć w czym jest problem"
	arr["GERMAN",581]="Sie haben satana mit aktivierten Silent-Checks gestartet. Deaktivieren Sie diese Option, um das Problem zu sehen"
	arr["TURKISH",581]="Etkinleştirilmiş sessiz kontrollerle satana'u başlattın. Sorunun ne olduğunu görmek için bu seçeneği devre dışı bırak"
	...
	arr["PORTUGUESE",590]="Você pode modificar manualmente o arquivo ${rc_path} para alterar suas opções ou usar argumentos ao executar satana na linha de comando. Mais informações em: ${urlgithub_wiki}/Options"
	...
	arr["ENGLISH",610]="Hashes obtained during an enterprise wifi network attack can be also decrypted using john the ripper tool. Dictionary or bruteforce attacks can be performed from satana menus"
	arr["SPANISH",610]="También se puede usar john the ripper para descifrar los hashes obtenidos en un ataque a una red wifi enterprise. Ataques de diccionario o por fuerza bruta pueden ser usados desde los menús de satana"
	arr["FRENCH",610]="Aussi c'est possible utiliser john the ripper pour déchiffrer les hashes obtenus lors d'une attaque contre un réseau wifi d'entreprise. Les attaques de dictionnaire ou la force brute peuvent être utilisées à partir des menus d'satana"
	arr["CATALAN",610]="També es pot utilitzar john the ripper per desxifrar els hashes obtinguts en un atac a una xarxa wifi enterprise. Atacs de diccionari o per força bruta poden ser usats des dels menús de satana"
	arr["PORTUGUESE",610]="Você também pode usar o john the ripper para descriptografar as hashes obtidas em um ataque a uma rede wifi enterprise. Ataques de dicionário ou força bruta, podem ser usados nos menus do satana"
	...
	arr["GREEK",610]="Τα hashes που καταγράφηκαν κατά τη διάρκεια κάποιας επίθεσης enterprise wifi δικτύου μπορούν επίσης να αποκρυπτογραφηθούν χρησιμοποιώντας το εργαλείο john the ripper. Μπορεί να πραγματοποιηθεί επίθεση με λεξικό ή bruteforce επιλέγοντας κάποια από τα δύο το μενού του satana"
	arr["ITALIAN",610]="È anche possibile utilizzare john the ripper per decifrare gli hash ottenuti in un attacco a una rete wifi enterprise. Gli attacchi di dizionario o forza bruta, possono essere utilizzati dai menu di satana"
	arr["POLISH",610]="Możesz również użyć john the ripper aby złamać hasze uzyskane podczas ataku na firmową sieć wifi. Ataki słownikowe lub bruteforce mogą być wykonane z menu satana"
	arr["GERMAN",610]="Sie können auch john the ripper verwenden, um die Hashes, die auf ein WLAN-Enterprise Netzwerk erhalten wurden, zu entschlüsseln. Wörterbuchangriffe oder Brute Force Angriffe können aus den Menüs von satana verwendet werden"
	arr["TURKISH",610]="Bir kurumsal wifi ağına yapılan saldırıda elde edilen hash şifresini çözmek için john the ripper'i kullanabilirsiniz. Dictionary veya bruteforce saldırıları satana menülerinden kullanılabilir"
	...
	arr["ENGLISH",621]="It's not possible to run satana in the current tmux session. This session will be send to background and a new tmux session will be created for launching satana"
	arr["SPANISH",621]="No es posible ejecutar satana en la sesión tmux actual. Esta sesión será enviada a segundo plano y se creará una nueva sesión tmux donde satana será lanzado"
	arr["FRENCH",621]="Il n'est pas possible de lancer satana dans la session de tmux en cours. Cette session sera envoyée à l’arrière-plan et une nouvelle session tmux sera crée pour lancer satana"
	arr["CATALAN",621]="No és possible executar satana en la sessió tmux actual. Aquesta sessió serà enviada a segon pla i es crearà una nova sessió tmux on satana serà llançat"
	arr["PORTUGUESE",621]="Não é possível executar o satana na sessão atual do tmux. Esta sessão será colocada em segundo plano e uma nova sessão do tmux será criada onde o satana será executado"
	...
	arr["GREEK",621]="Δεν είναι δυνατό να εκτελέσετε satana στην τρέχουσα συνεδρία tmux. Αυτή η συνεδρία θα στείλει στο παρασκήνιο και θα δημιουργηθεί μια νέα συνεδρία tmux για την εκκίνηση του satana"
	arr["ITALIAN",621]="Non è possibile eseguire satana nella sessione corrente di tmux. Questa sessione verrà mandata in background e verrà creata una nuova sessione tmux in cui verrà lanciato satana"
	arr["POLISH",621]="Nie można uruchomić satana w bieżącej sesji tmux. Ta sesja zostanie wysłana na drugi plan. Zostanie utworzona nowa sesja tmux, w której będzie uruchomiony satana"
	arr["GERMAN",621]="Es ist nicht möglich, satana in der aktuellen tmux-Sitzung auszuführen. Diese Sitzung wird in den Hintergrund gesendet und eine neue Sitzung wird erstellt, in der satana gestartet wird"
	arr["TURKISH",621]="Mevcut tmux seansında satana çalıştırmak mümkün değildir. Bu oturum arka plana gönderilecek ve satana'un başlatılacağı yeni bir tmux oturumu oluşturulacak"
	...
	arr["ENGLISH",626]="Since satana 9.20 version, tmux is supported and it can be used instead of xterm as windows handler. Script can be launched in a headless environment without a graphical X window system. It is recommended only for advanced users. Like any other option, it can be configured on the options menu, on the ${rc_path} options file or launched using ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} \"flag\" in the command line. More information about options customization at Wiki: ${urlgithub_wiki}/Options"
	arr["SPANISH",626]="A partir de la versión 9.20 de satana, tmux está soportado y se puede utilizar en lugar de xterm como gestor de ventanas. Se puede lanzar el script en un entorno sin un sistema gráfico de ventanas X. Solo se recomienda hacerlo para usuarios avanzados. Como cualquier otra opción, se puede configurar desde el menú de opciones, configurarlo en el fichero de opciones ${rc_path} o lanzarlo usando el \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} en la línea de comandos. Más información acerca de la personalización de opciones en el Wiki: ${urlgithub_wiki}/Options"
	arr["FRENCH",626]="À partir de la version 9.20 d'satana, tmux est supporté et peut être utilisé à la place de xterm en tant que gestionnaire de fenêtres. Vous pouvez lancer le script dans un environnement dépourvu de système graphique X Windows. Il est recommandé aux utilisateurs avancés. Comme toute autre option, elle peut être configurée à partir du menu d'options, dans le fichier d'options ${rc_path} ou le lancer à l'aide de \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} sur la ligne de commande. Plus d'informations sur la personnalisation des options dans le Wiki: ${urlgithub_wiki}/Options"
	arr["CATALAN",626]="A partir de la versió 9.20 de satana, tmux està suportat i es pot utilitzar en lloc de xterm com a gestor de finestres. Es pot llançar l'script en un entorn sense un sistema gràfic de finestres X. Només es recomana fer-ho per a usuaris avançats. Com qualsevol altra opció, es pot configurar des del menú d'opcions, configurar en el fitxer d'opcions ${rc_path} o llançar usant el \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} en la línia d'ordres. Més informació sobre la personalització d'opcions al Wiki: ${urlgithub_wiki}/Options"
	arr["PORTUGUESE",626]="A partir da versão 9.20 do satana, o tmux pode ser usado em vez do xterm como gerenciador de janelas. Você pode iniciar o script em um ambiente sem um sistema gráfico (X-Window). É recomendado apenas para usuários avançados. Como as demais opções, pode ser configurado a partir do menu, configurado no arquivo de opções ${rc_path} ou iniciado usando o \"parâmetro\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} na linha de comando. Mais informações sobre a customização de opções no Wiki: ${urlgithub_wiki}/Options"
	...
	arr["GREEK",626]="Από την έκδοση 9.20 του satana, υποστηρίζεται το tmux και μπορεί να χρησιμοποιηθεί αντί του xterm ως χειριστής παραθύρων. Το script μπορεί να εκκινηθεί σε headless περιβάλλον χωρίς γραφικό σύστημα παραθύρου X. Συνιστάται μόνο για προχωρημένους χρήστες. Όπως και κάθε άλλη επιλογή, μπορεί να ρυθμιστεί στο μενού επιλογών, στο αρχείο επιλογών ${rc_path} ή να εκκινηθεί χρησιμοποιώντας το \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} στη γραμμή εντολών. Περισσότερες πληροφορίες σχετικά με την προσαρμογή των επιλογών στο Wiki: ${urlgithub_wiki}/Options"
	arr["ITALIAN",626]="A partire dalla versione 9.20 di satana, tmux è supportato e può essere usato al posto di xterm come gestore di finestre. È possibile avviare lo script in un ambiente senza un sistema grafico di finestre X. È consigliato solo per utenti esperti. Come qualsiasi altra opzione, può essere configurata dal menu delle opzioni, configurata nel file delle opzioni ${rc_path} o avviata utilizzando il \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} dalla linea di comando. Maggiori informazioni sulla personalizzazione delle opzioni nella Wiki: ${urlgithub_wiki}/Options"
	arr["POLISH",626]="Począwszy od wersji 9.20 satana, tmux jest obsługiwany i może być używany zamiast xterm jako menedżer okien. Skrypt można uruchomić w środowisku bez systemu graficznego X window. Zalecany jest tylko dla zaawansowanych użytkowników. Jak każdą inna opcję, można ją skonfigurować z menu, w pliku opcji ${rc_path} lub uruchomić za pomocą \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} w wierszu poleceń. Więcej informacji na temat dostosowywania opcji w Wiki: ${urlgithub_wiki}/Options"
	arr["GERMAN",626]="Ab satana Version 9.20 wird tmux unterstützt und kann anstelle von xterm als Fenstermanager verwendet werden. Sie können das Skript in einer Umgebung ohne Grafiksystem von X-Fenstern starten, es wird nur für fortgeschrittene Benutzer empfohlen. Wie jede andere Option kann sie über das Optionsmenü konfiguriert werden, in der Optionsdatei ${rc_path} konfiguriert oder mit dem \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} in der Befehlszeile gestartet werden. Weitere Informationen zur Anpassung der Optionen im Wiki: ${urlgithub_wiki}/Options"
	arr["TURKISH",626]="satana'un 9.20 sürümünden itibaren, tmux destekleniyor ve bir pencere yöneticisi olarak xterm yerine kullanılabilir. Senaryoyu X windows grafik sistemine sahip olmayan bir ortamda başlatabilirsiniz, sadece ileri düzey kullanıcılar için önerilir. Diğer seçeneklerde olduğu gibi, seçenekler menüsünden yapılandırılabilir, ${rc_path} seçenekler dosyasında yapılandırılabilir veya komut satırında \"flag\" ${normal_color}SATANA_WINDOWS_HANDLING${pink_color} kullanılarak başlatılabilir. Wiki'deki seçeneklerin özelleştirilmesi hakkında daha fazla bilgi: ${urlgithub_wiki}/Options"
	...
	arr["ENGLISH",636]="There is an error in your configuration. Please check the ${rc_path} file. You have enabled the option to force the use of mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}) but your system doesn't have mdk3 installed. Disable this option or install mdk3 to fix the problem"
	arr["SPANISH",636]="Hay un error en tu configuración. Por favor revisa el fichero ${rc_path}. Has activado la opción para forzar el uso de mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}) pero tu sistema no tiene mdk3 instalado. Deshabilita esta opción o instala mdk3 para solucionar el problema"
	arr["FRENCH",636]="Il y a une erreur dans votre configuration. Veuillez vérifier le fichier ${rc_path}. Vous avez activé l'option pour forcer l'utilisation de mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}) mais mdk3 n'est pas installé sur votre système. Désactivez cette option ou installez mdk3 pour résoudre le problème"
	arr["CATALAN",636]="Hi ha un error en la configuració. Si us plau comprova el fitxer ${rc_path}. Has activat l'opció per forçar l'ús d'mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}) però el teu sistema no té mdk3 instal·lat. Deshabilita aquesta opció o instal·la mdk3 per solucionar el problema"
	arr["PORTUGUESE",636]="Existe um erro na sua configuração. Por favor, verifique o arquivo ${rc_path}. Você ativou a opção para forçar o uso de mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}), mas seu sistema não possui o mdk3 instalado. Desabilite esta opção ou instale o mdk3 para resolver o problema"
	...
	arr["GREEK",636]="Υπάρχει ένα σφάλμα στο configuration σας. Παρακαλώ ελέγξτε το αρχείο ${rc_path}. Έχετε ενεργοποιήσει την επιλογή που εξαναγκάζει τη χρήση του mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}) αλλά το σύστημά σας δεν έχει το mdk3 εγκατεστημένο. Απενεργοποιήστε την επιλογή αυτή ή εγκαταστήστε το mdk3 για να επιλυθεί το πρόβλημα"
	arr["ITALIAN",636]="C'è un errore nella tua configurazione. Per favore controlla il file ${rc_path}. Hai attivato l'opzione per forzare l'uso di mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}) ma il tuo sistema non ha mdk3 installato. Disabilita questa opzione o installa mdk3 per risolvere il problema"
	arr["POLISH",636]="Wystąpił błąd konfiguracji. Sprawdź plik ${rc_path}. Aktywowałeś opcję wymuszania użycia mdk3 (${normal_color}SATANA_MDK_VERSION${red_color}), ale twój system nie ma zainstalowanego mdk3. Wyłącz tę opcję lub zainstaluj mdk3, aby rozwiązać problem"
	arr["GERMAN",636]="Ein Fehler wurde in Ihren Einstellungen gefunden. Bitte überprüfen Sie die Datei ${rc_path}. Sie haben die Option aktiviert, um die Verwendung von mdk3 zu erzwingen (${normal_color}SATANA_MDK_VERSION${red_color}), aber auf Ihrem System ist mdk3 nicht installiert. Deaktivieren Sie diese Option oder installieren Sie mdk3, um dieses Problem zu lösen"
	arr["TURKISH",636]="Yapılandırmanızda bir hata var. Lütfen ${rc_path} dosyasını kontrol edin. (${normal_color}SATANA_MDK_VERSION${red_color}) mdk3 kullanımını zorlama seçeneğini etkinleştirdiniz, ancak sisteminizde mdk3 kurulu değil. Bu seçeneği devre dışı bırakın veya sorunu çözmek için mdk3 yükleyin"
	...
	arr["ENGLISH",645]="${green_color}Do you want to use custom certificates during the attack? ${blue_color}If you answer no \"n\", satana will use ones by default. if you answer yes \"y\" then you will have to provide their path and know the password with which they were generated ${normal_color}${visual_choice}"
	arr["SPANISH",645]="${green_color}¿Quieres utilizar certificados personalizados durante el ataque? ${blue_color}Si respondes no \"n\", satana utilizará unos por defecto. Si respondes sí \"y\" entonces tendrás que proporcionar la ruta de los mismos y conocer la contraseña con la que fueron generados ${normal_color}${visual_choice}"
	arr["FRENCH",645]="${green_color}Voulez-vous utiliser des certificats personnalisés pendant l'attaque? ${blue_color}Si vous répondez non \"n\", satana les utilisera par défaut. Si vous répondez oui \"y\", vous devrez introduire leur chemin et connaître le mot de passe avec lequel ils ont été générés ${normal_color}${visual_choice}"
	arr["CATALAN",645]="${green_color}Vols fer servir certificats personalitzats durant l'atac? ${blue_color}Si respons no \"n\", satana utilitzarà uns per defecte. si respons sí \"y\" llavors hauràs de proporcionar la ruta dels mateixos i conèixer la contrasenya amb la qual van ser generats ${normal_color}${visual_choice}"
	arr["PORTUGUESE",645]="${green_color}Você quer usar certificados personalizados durante o ataque? ${blue_color}Se você responder não \"n\", o satana irá usar os padrões. Se você responder sim \"y\", então você terá que fornecer o caminho e saber a senha com a qual eles foram gerados ${normal_color}${visual_choice}"
	...
	arr["GREEK",645]="${green_color}Θέλετε να χρησιμοποιήσετε προσαρμοσμένα πιστοποιητικά κατά τη διάρκεια της επίθεσης; ${blue_color}Εάν απαντήσετε όχι \"n\", το satana θα χρησιμοποιήσει αυτά από προεπιλογή. Αν απαντήσετε ναι \"y\" τότε θα πρέπει να δώσετε τη διαδρομή τους και να γνωρίσετε τον κωδικό πρόσβασης με τον οποίο δημιουργήθηκαν ${normal_color}${visual_choice}"
	arr["ITALIAN",645]="${green_color}Vuoi usare certificati personalizzati durante l'attacco? ${blue_color}Se rispondi no \"n\", satana ne utilizzerà uno di default. se rispondi sì \"y\" dovrai fornire il loro percorso e conoscere la password con cui sono stati generati ${normal_color}${visual_choice}"
	arr["POLISH",645]="${green_color}Czy chcesz używać niestandardowych certyfikatów podczas ataku? ${blue_color}Jeśli odpowiesz nie \"n\", satana użyje domyślnych. Jeśli odpowiesz tak \"y\", będziesz musiał podać ścieżkę i hasło użyte do ich wygenerowania ${normal_color}${visual_choice}"
	arr["GERMAN",645]="${green_color}Möchten Sie während des Angriffs benutzerdefinierte Zertifikate verwenden? ${blue_color}Wenn sie mit Nein \"n\" antworten, verwendet satana die Standardzertifikaten. wenn sie mit Ja \"y\" antworten, müssen Sie deren Pfad und das Kennwort eingeben, mit dem sie generiert wurden ${normal_color}${visual_choice}"
	arr["TURKISH",645]="${green_color}Saldırı sırasında özel sertifikalar kullanmak ister misiniz? ${blue_color}Hayır \"n\" cevabını verirseniz, satana varsayılanları kullanacaktır. eğer evet \"y\" cevabını verirseniz, yollarını belirtmeniz ve oluşturdukları şifreyi bilmeniz gerekir ${normal_color}${visual_choice}"

	arr["ENGLISH",646]="${blue_color}satana has detected that custom certificates have been generated during this session. ${green_color}Do you want to use them during the attack? ${normal_color}${visual_choice}"
	arr["SPANISH",646]="${blue_color}satana ha detectado que han sido generados unos certificados personalizados durante esta sesión. ${green_color}¿Quieres utilizarlos durante el ataque? ${normal_color}${visual_choice}"
	arr["FRENCH",646]="${blue_color}satana a détecté que des certificats personnalisés ont été générés au cours de cette session. ${green_color}Voulez-vous les utiliser pendant l'attaque? ${normal_color}${visual_choice}"
	arr["CATALAN",646]="${blue_color}satana ha detectat que han estat generats uns certificats personalitzats durant aquesta sessió. ${green_color}Vols utilitzar-los durant l'atac? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",646]="${blue_color}satana detectou que certificados personalizados foram gerados durante esta sessão. ${green_color}Você quer usá-los durante o ataque? ${normal_color}${visual_choice}"
	...
	arr["GREEK",646]="${blue_color}Το satana έχει εντοπίσει ότι έχουν δημιουργηθεί προσαρμοσμένα πιστοποιητικά κατά τη διάρκεια αυτής της περιόδου σύνδεσης. ${green_color}Θέλετε να τα χρησιμοποιήσετε κατά τη διάρκεια της επίθεσης; ${normal_color} ${visual_choice}"
	arr["ITALIAN",646]="${blue_color}satana ha rilevato che durante questa sessione sono stati generati certificati personalizzati. ${green_color}Vuoi usarli durante l'attacco? ${normal_color}${visual_choice}"
	arr["POLISH",646]="${blue_color}satana wykrył, że podczas tej sesji wygenerowano niestandardowe certyfikaty. ${green_color}Czy chcesz ich użyć podczas ataku? ${normal_color}${visual_choice}"
	arr["GERMAN",646]="${blue_color}satana hat bemerkt, dass während dieser Sitzung benutzerdefinierte Zertifikate generiert wurden. ${green_color}Möchten Sie diese während des Angriffs benutzen? ${normal_color}${visual_choice}"
	arr["TURKISH",646]="${blue_color}satana, bu oturum sırasında özel sertifikaların oluşturulduğunu tespit etti. ${green_color}Onları saldırı sırasında kullanmak istiyor musunuz? ${normal_color}${visual_choice}"
	...
	arr["ENGLISH",648]="Previously generated by satana certificates will be used"
	arr["SPANISH",648]="Se utilizarán los certificados generados anteriormente con satana"
	arr["FRENCH",648]="Les certificats avant générés avec satana seront utilisés"
	arr["CATALAN",648]="S'utilitzaran els certificats generats anteriorment amb satana"
	arr["PORTUGUESE",648]="Os certificados previamente gerados com satana serão usados"
	arr["RUSSIAN",648]="Будут использованы сертификаты, сгенерированные с satana"
	arr["GREEK",648]="Θα χρησιμοποιηθούν τα προηγούμενα πιστοποιητικά που δημιουργήθηκαν από satana"
	arr["ITALIAN",648]="Verranno utilizzati i certificati generati in precedenza con satana"
	arr["POLISH",648]="Zostaną wykorzystane certyfikaty wygenerowane wcześniej z satana"
	arr["GERMAN",648]="Mit satana erstellte Zertifikate werden verwendet"
	arr["TURKISH",648]="Daha önce satana ile üretilen sertifikalar kullanılacak"
	...
	arr["ENGLISH",663]="Download dictionaries menu"
	arr["SPANISH",663]="Menú de descarga de diccionarios"
	arr["FRENCH",663]="Menu de téléchargement de dictionnaires"
	arr["CATALAN",663]="Menú de descàrrega de diccionaris"
	arr["PORTUGUESE",663]="Menu de download de dicionários"
	arr["RUSSIAN",663]="Меню скачивания словарей"
	arr["GREEK",663]="Μενού λήψης λεξικών"
	arr["ITALIAN",663]="Menu download dizionari"
	arr["POLISH",663]="Menu pobierania słowników"
	arr["GERMAN",663]="Wörterbuch-Download-Menü"
	arr["TURKISH",663]="Sözlük indirme menüsü"

	arr["ENGLISH",664]="11. Download dictionaries menu"
	arr["SPANISH",664]="11. Menú de descarga de diccionarios"
	arr["FRENCH",664]="11. Menu de téléchargement de dictionnaires"
	arr["CATALAN",664]="11. Menú de descàrrega de diccionaris"
	arr["PORTUGUESE",664]="11. Menu de download de dicionários"
	arr["RUSSIAN",664]="11. Скачать словари"
	arr["GREEK",664]="11. Μενού λήψης λεξικών"
	arr["ITALIAN",664]="11. Menu download dizionari"
	arr["POLISH",664]="11. Menu pobierania słowników"
	arr["GERMAN",664]="11. Wörterbuch-Download-Menü"
	arr["TURKISH",664]="11. Sözlük indirme menüsü"

	arr["ENGLISH",665]="1.  rockyou.txt (~14 million passwords)"
	arr["SPANISH",665]="1.  rockyou.txt (~14 millones de contraseñas)"
	arr["FRENCH",665]="1.  rockyou.txt (~14 millions de mots de passe)"
	arr["CATALAN",665]="1.  rockyou.txt (~14 milions de contrasenyes)"
	arr["PORTUGUESE",665]="1.  rockyou.txt (~14 milhões de senhas)"
	arr["RUSSIAN",665]="1.  rockyou.txt (~14 млн паролей)"
	arr["GREEK",665]="1.  rockyou.txt (~14 εκατομμύρια κωδικών)"
	arr["ITALIAN",665]="1.  rockyou.txt (~14 milioni di password)"
	arr["POLISH",665]="1.  rockyou.txt (~14 milionów haseł)"
	arr["GERMAN",665]="1.  rockyou.txt (~14 Millionen Passwörter)"
	arr["TURKISH",665]="1.  rockyou.txt (~14 milyon parola)"

	arr["ENGLISH",666]="2.  probable-v2-wpa-top4800.txt (WiFi WPA top passwords)"
	arr["SPANISH",666]="2.  probable-v2-wpa-top4800.txt (contraseñas WiFi WPA más comunes)"
	arr["FRENCH",666]="2.  probable-v2-wpa-top4800.txt (mots de passe WiFi WPA les plus courants)"
	arr["CATALAN",666]="2.  probable-v2-wpa-top4800.txt (contrasenyes WiFi WPA més comunes)"
	arr["PORTUGUESE",666]="2.  probable-v2-wpa-top4800.txt (senhas WiFi WPA mais comuns)"
	arr["RUSSIAN",666]="2.  probable-v2-wpa-top4800.txt (топ паролей WiFi WPA)"
	arr["GREEK",666]="2.  probable-v2-wpa-top4800.txt (κορυφαίοι κωδικοί WiFi WPA)"
	arr["ITALIAN",666]="2.  probable-v2-wpa-top4800.txt (password WiFi WPA più comuni)"
	arr["POLISH",666]="2.  probable-v2-wpa-top4800.txt (najpopularniejsze hasła WiFi WPA)"
	arr["GERMAN",666]="2.  probable-v2-wpa-top4800.txt (häufigste WiFi WPA-Passwörter)"
	arr["TURKISH",666]="2.  probable-v2-wpa-top4800.txt (en yaygın WiFi WPA parolaları)"

	arr["ENGLISH",667]="Downloading dictionary file..."
	arr["SPANISH",667]="Descargando fichero de diccionario..."
	arr["FRENCH",667]="Téléchargement du fichier dictionnaire..."
	arr["CATALAN",667]="Descarregant fitxer de diccionari..."
	arr["PORTUGUESE",667]="Baixando arquivo de dicionário..."
	arr["RUSSIAN",667]="Скачивание файла словаря..."
	arr["GREEK",667]="Λήψη αρχείου λεξικού..."
	arr["ITALIAN",667]="Download del file dizionario in corso..."
	arr["POLISH",667]="Pobieranie pliku słownika..."
	arr["GERMAN",667]="Wörterbuchdatei wird heruntergeladen..."
	arr["TURKISH",667]="Sözlük dosyası indiriliyor..."

	arr["ENGLISH",668]="Dictionary file successfully downloaded to: ${pink_color}${dict_path}${normal_color}"
	arr["SPANISH",668]="Fichero de diccionario descargado con éxito en: ${pink_color}${dict_path}${normal_color}"
	arr["FRENCH",668]="Fichier dictionnaire téléchargé avec succès dans: ${pink_color}${dict_path}${normal_color}"
	arr["CATALAN",668]="Fitxer de diccionari descarregat amb èxit a: ${pink_color}${dict_path}${normal_color}"
	arr["PORTUGUESE",668]="Arquivo de dicionário baixado com sucesso em: ${pink_color}${dict_path}${normal_color}"
	arr["RUSSIAN",668]="Файл словаря успешно скачан в: ${pink_color}${dict_path}${normal_color}"
	arr["GREEK",668]="Το αρχείο λεξικού κατέβηκε με επιτυχία στο: ${pink_color}${dict_path}${normal_color}"
	arr["ITALIAN",668]="File dizionario scaricato con successo in: ${pink_color}${dict_path}${normal_color}"
	arr["POLISH",668]="Plik słownika został pomyślnie pobrany do: ${pink_color}${dict_path}${normal_color}"
	arr["GERMAN",668]="Wörterbuchdatei erfolgreich heruntergeladen nach: ${pink_color}${dict_path}${normal_color}"
	arr["TURKISH",668]="Sözlük dosyası başarıyla indirildi: ${pink_color}${dict_path}${normal_color}"

	arr["ENGLISH",669]="An error occurred while trying to download the dictionary file"
	arr["SPANISH",669]="Se ha producido un error al intentar descargar el fichero de diccionario"
	arr["FRENCH",669]="Une erreur s'est produite lors du téléchargement du fichier dictionnaire"
	arr["CATALAN",669]="S'ha produït un error en intentar descarregar el fitxer de diccionari"
	arr["PORTUGUESE",669]="Ocorreu um erro ao tentar baixar o arquivo de dicionário"
	arr["RUSSIAN",669]="Произошла ошибка при попытке скачать файл словаря"
	arr["GREEK",669]="Παρουσιάστηκε σφάλμα κατά τη λήψη του αρχείου λεξικού"
	arr["ITALIAN",669]="Si è verificato un errore durante il download del file dizionario"
	arr["POLISH",669]="Wystąpił błąd podczas pobierania pliku słownika"
	arr["GERMAN",669]="Beim Herunterladen der Wörterbuchdatei ist ein Fehler aufgetreten"
	arr["TURKISH",669]="Sözlük dosyası indirilirken bir hata oluştu"

	arr["ENGLISH",670]="The dictionary file already exists (${pink_color}${dict_path}${normal_color}). Do you want to download it again? ${normal_color}${visual_choice}"
	arr["SPANISH",670]="El fichero de diccionario ya existe (${pink_color}${dict_path}${normal_color}). ¿Quieres descargarlo de nuevo? ${normal_color}${visual_choice}"
	arr["FRENCH",670]="Le fichier dictionnaire existe déjà (${pink_color}${dict_path}${normal_color}). Voulez-vous le télécharger à nouveau? ${normal_color}${visual_choice}"
	arr["CATALAN",670]="El fitxer de diccionari ja existeix (${pink_color}${dict_path}${normal_color}). Vols descarregar-lo de nou? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",670]="O arquivo de dicionário já existe (${pink_color}${dict_path}${normal_color}). Deseja baixá-lo novamente? ${normal_color}${visual_choice}"
	arr["RUSSIAN",670]="Файл словаря уже существует (${pink_color}${dict_path}${normal_color}). Скачать заново? ${normal_color}${visual_choice}"
	arr["GREEK",670]="Το αρχείο λεξικού υπάρχει ήδη (${pink_color}${dict_path}${normal_color}). Θέλετε να το κατεβάσετε ξανά; ${normal_color}${visual_choice}"
	arr["ITALIAN",670]="Il file dizionario esiste già (${pink_color}${dict_path}${normal_color}). Vuoi scaricarlo di nuovo? ${normal_color}${visual_choice}"
	arr["POLISH",670]="Plik słownika już istnieje (${pink_color}${dict_path}${normal_color}). Czy chcesz pobrać go ponownie? ${normal_color}${visual_choice}"
	arr["GERMAN",670]="Die Wörterbuchdatei existiert bereits (${pink_color}${dict_path}${normal_color}). Erneut herunterladen? ${normal_color}${visual_choice}"
	arr["TURKISH",670]="Sözlük dosyası zaten mevcut (${pink_color}${dict_path}${normal_color}). Tekrar indirilsin mi? ${normal_color}${visual_choice}"

	arr["ENGLISH",671]="You don't have curl or wget installed. It's not possible to download dictionary files"
	arr["SPANISH",671]="No tienes curl ni wget instalados. No es posible descargar ficheros de diccionario"
	arr["FRENCH",671]="Vous n'avez pas curl ou wget installé. Impossible de télécharger des fichiers dictionnaire"
	arr["CATALAN",671]="No tens curl ni wget instal·lats. No és possible descarregar fitxers de diccionari"
	arr["PORTUGUESE",671]="Você não tem curl ou wget instalados. Não é possível baixar arquivos de dicionário"
	arr["RUSSIAN",671]="У вас не установлены curl или wget. Скачивание словарей невозможно"
	arr["GREEK",671]="Δεν έχετε εγκατεστημένο curl ή wget. Δεν είναι δυνατή η λήψη αρχείων λεξικού"
	arr["ITALIAN",671]="Non hai curl o wget installati. Non è possibile scaricare file dizionario"
	arr["POLISH",671]="Nie masz zainstalowanego curl ani wget. Pobieranie plików słownika jest niemożliwe"
	arr["GERMAN",671]="Sie haben weder curl noch wget installiert. Wörterbuchdateien können nicht heruntergeladen werden"
	arr["TURKISH",671]="curl veya wget yüklü değil. Sözlük dosyaları indirilemiyor"

	arr["ENGLISH",672]="Dictionaries are saved in: ${pink_color}${dict_folder}${normal_color}"
	arr["SPANISH",672]="Los diccionarios se guardan en: ${pink_color}${dict_folder}${normal_color}"
	arr["FRENCH",672]="Les dictionnaires sont enregistrés dans: ${pink_color}${dict_folder}${normal_color}"
	arr["CATALAN",672]="Els diccionaris es desen a: ${pink_color}${dict_folder}${normal_color}"
	arr["PORTUGUESE",672]="Os dicionários são salvos em: ${pink_color}${dict_folder}${normal_color}"
	arr["RUSSIAN",672]="Словари сохраняются в: ${pink_color}${dict_folder}${normal_color}"
	arr["GREEK",672]="Τα λεξικά αποθηκεύονται στο: ${pink_color}${dict_folder}${normal_color}"
	arr["ITALIAN",672]="I dizionari vengono salvati in: ${pink_color}${dict_folder}${normal_color}"
	arr["POLISH",672]="Słowniki są zapisywane w: ${pink_color}${dict_folder}${normal_color}"
	arr["GERMAN",672]="Wörterbücher werden gespeichert in: ${pink_color}${dict_folder}${normal_color}"
	arr["TURKISH",672]="Sözlükler şuraya kaydedilir: ${pink_color}${dict_folder}${normal_color}"
